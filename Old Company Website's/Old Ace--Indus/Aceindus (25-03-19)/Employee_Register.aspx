<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Employee_Register.aspx.cs" Inherits="Employee_Register" %>
...
<td width="2%"></td>
    ...
    <td width="13%" class="headings2" align="left">
     ...
     <asp:TextBox ID="mmname" runat="server" CssClass="textfield" Width="190px" 
             BorderWidth="1" ></asp:TextBox>
         <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ControlToValidate="mmname"></asp:RequiredFieldValidator>--%>
...
<td width="2%"></td>
    ...
    <td width="13%" class="headings2" align="left">
     ...
     <td width="26%" align="left">
             ...
             <asp:DropDownList ID="ddlday1" runat="server" Width="61px">
        </asp:DropDownList>&nbsp;
...
<tr>
    ...
    <td width="13%" class="headings2" align="left">
     ...
     <td width="26%" align="left">
            ...
            <asp:DropDownList ID="ddlday4" runat="server"   
                  Width="58px">
        </asp:DropDownList>&nbsp;
        <asp:DropDownList ID="ddlmonth4" runat="server">
            <asp:ListItem Value="Select">Select</asp:ListItem>
            <asp:ListItem Value="1">Jan</asp:ListItem>
            <asp:ListItem Value="2">Feb</asp:ListItem>
            <asp:ListItem Value="3">Mar</asp:ListItem>
        ...
        <asp:DropDownList ID="ddlyear4" runat="server"   
                  Width="66px">
        </asp:DropDownList><br />
             <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ErrorMessage="*" ControlToValidate="bdate" ></asp:RequiredFieldValidator>--%>
                                 ...
                                 <asp:RequiredFieldValidator ID="reqddlmonth" runat="server" ErrorMessage="*" ControlToValidate="ddlmonth4" InitialValue="Select"></asp:RequiredFieldValidator>
                                 <asp:RequiredFieldValidator ID="reqddlday" runat="server" ErrorMessage="*" ControlToValidate="ddlday4" InitialValue="Select"></asp:RequiredFieldValidator>
                                 <asp:RequiredFieldValidator ID="reqddlyear" runat="server" ErrorMessage="*" ControlToValidate="ddlyear4" InitialValue="Select"></asp:RequiredFieldValidator>
...
<td width="1%" ></td>
    ...
    <td width="13%"  align="left"  class="headings2">
     ...
     <td width="2%">:</td>
     <td width="25%" align="left">
     <input id="pplace" class="data" runat="server" style="width: 146px" />
    ...
    <td width="13%"  align="left"  class="headings2">
     ...
     <td width="25%" align="left">
             ...
             <asp:DropDownList ID="ddlday6" runat="server" Width="54px">
        </asp:DropDownList>&nbsp;
        <asp:DropDownList ID="ddlmonth6" runat="server">
            <asp:ListItem Value="Select">Select</asp:ListItem>
            <asp:ListItem Value="1">Jan</asp:ListItem>
            <asp:ListItem Value="2">Feb</asp:ListItem>
            <asp:ListItem Value="3">Mar</asp:ListItem>
        ...
        <asp:DropDownList ID="ddlyear6" runat="server"   
              Width="73px">
        </asp:DropDownList><br />
                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ErrorMessage="*" ControlToValidate="ddlmonth6" InitialValue="Select"></asp:RequiredFieldValidator>
                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ErrorMessage="*" ControlToValidate="ddlday6" InitialValue="Select"></asp:RequiredFieldValidator>
                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" ErrorMessage="*" ControlToValidate="ddlyear6" InitialValue="Select"></asp:RequiredFieldValidator>
     ...
     <td width="26%" align="left" >
        ...
        <asp:DropDownList ID="ddlexpyear" runat="server"   
                   Width="63px">
                                 ...
                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator39" runat="server" ErrorMessage="*" ControlToValidate="ddlexpmonth" InitialValue="Select"></asp:RequiredFieldValidator>
                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator40" runat="server" ErrorMessage="*" ControlToValidate="ddlexpday" InitialValue="Select"></asp:RequiredFieldValidator>
                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator41" runat="server" ErrorMessage="*" ControlToValidate="ddlexpyear" InitialValue="Select"></asp:RequiredFieldValidator>
...
<asp:CheckBox ID="termscond" Checked="true" runat="server" Text="" />
        ...
        use of <a href="http://www.igiit.ws" target="_blank">igiit.ws</a> 
