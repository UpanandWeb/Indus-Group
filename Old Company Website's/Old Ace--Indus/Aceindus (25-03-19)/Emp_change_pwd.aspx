<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Emp_change_pwd.aspx.cs" Inherits="Emp_change_pwd" %>
...
<head runat="server">
<title>:: Ace Indus :: Employee Change Password.</title>
...
<a href="http://www.aceindus.in/new_employeeform.aspx">New Employee Form</a>
  ...
  <tr>
        <td class="style1"> Employee Change Password :</td>
  </tr>
  <tr>
  <!-- start the DIV-->
        ...
        <tr>
          <td colspan="3" align="center"><label> </label>
              <div align="center">
                  ...
                  &nbsp;&nbsp;
                  <asp:ImageButton ID="imgcancel" runat="server" Height="22px" 
                      ImageUrl="~/images/cancel_btn.gif" Width="86px" 
                      />
              </div>
          </td>
        </tr>
