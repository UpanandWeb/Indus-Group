<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserData.aspx.cs" Inherits="UaerData" %>
        ...
        <td width="29%" valign="middle"><table width="100%" border="0" class="text" style="font-size:11px">
           <tr>
            ...
            <td width="64" align="left" valign="top"><a href="http://www.aceindus.in/login.aspx">
                <asp:LinkButton ID="lnklogin" runat="server" Text="Login" PostBackUrl="login.aspx" ></asp:LinkButton></a>
...
<a href="http://www.aceindus.in/new_employeeform.aspx">New Employee Form</a>
  ...
  <!-- start the DIV-->
    <td  valign="top" align="left"><div id="contentbox">
         ...
         <div ><table width="100%" border="0" class="text">
  <tr>
    <td >
                                             ...
                                             <tr>
                                                        ...
                                                        <tr>
                                                            <td colspan="10" align="center">
                                                                ...
                                                                <asp:Button ID="Button2" runat="server" Text="Submit" Width="70px" Height="30px" OnClick="btnsubmit_Click" ValidationGroup="emp" />
...
<div class="footerbottam" align="center">Copy right @1999-2013 Ace Indus Tech -Sol, 
