...
<title>:: Ace Indus ::  Vendor Register page</title>
...
<table width="1014px" border="0" class="main">
  <tr>
    ...
    <table width="100%" border="0">
      <tr>
        <td width="26%" height="48" valign="middle"><a href="Default.aspx"><img src="images/logo.png" width="199" height="46" border="0"/></a></td>
        <td width="25%" align="left" style="padding-left:70px"><a href="#"><img src="images/iso1.png" width="131" height="60" style="border:none" /></a></td>
        <td width="21%" valign="middle">
        <table width="100%" border="0" class="text" style="font-size:11px">
           <tr>
            <td width="11" align="left" valign="top"><img src="images/home-icon.png" width="13" height="16" /></td>
            ...
            <td width="70" align="left" valign="top"><a href="http://www.aceindus.in/login.aspx">Login</a></td>
          </tr>
             <tr>
                <td>
                    <br />
      ...
      <tr>
        <td class="style1">
            <table border="0" width="100%"> 
                <tr>
                    <td class="innertext" colspan="2">Vendor Register :</td>
                </tr>
                <tr height="10px">
                    <td></td>
                </tr>
                              ...
                              <td colspan="3" align="left" valign="top" style="height: 15px" class="lable4">&nbsp;&nbsp;
                                  <table border="0">
                                    <tr>
                                        ...
                                        <td width="100%">
                                             <p>I have read and understood and agree to the <a href="#">Terms and Conditions</a> 
