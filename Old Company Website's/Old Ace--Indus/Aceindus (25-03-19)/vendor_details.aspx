<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vendor_details.aspx.cs" Inherits="vendor_details" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>:: Ace Indus :: Vendor Details</title>
...
<a href="http://www.aceindus.in/new_employeeform.aspx">New Employee Form</a>
  ...
  <tr>
    <td class="innertext">Vendor Details :</td>
  </tr>
  <tr>
    <td style=" padding-left:20px;padding-top:10px; width:100%;line-height:25px" valign="top" align="center">
        <asp:DataList ID="DataList1" runat="server" Width="100%" Visible="true">
            ...
            <table width="100%" border="0">
             <tr>
                <td height="30" style="background:url(images/regiterlinebg.png) repeat-x; color:Red"><b>Vendor Information</b></td>
             </tr>
          <tr>
        ...
        <td><strong><asp:Label ID="Label4" runat="server" Text="Company Name"></asp:Label></strong></td>
         <td><asp:Label ID="Label5" runat="server"  Text='<%#Eval("cname ") %>'></asp:Label>
            </td>
        </tr>
        <tr>
        <td><strong><asp:Label ID="Label7" runat="server" Text="Company Email"></asp:Label></strong></td>
        <td><asp:Label ID="Label8" runat="server"   Text='<%#Eval("cemail") %>'></asp:Label> </td>
        </tr>
        ...
        <td> <asp:Label ID="Label12" runat="server"   Text='<%#Eval("indtype ") %>'></asp:Label></td>
        </tr>
        <tr>
        <td><strong><asp:Label ID="Label2" runat="server" Text="Contact person"></asp:Label></strong></td>
        <td><asp:Label ID="Label6" runat="server"   Text='<%#Eval("cperson") %>'></asp:Label> </td>
        </tr>
                <tr>
        <td><strong><asp:Label ID="Label9" runat="server" Text="Designation"></asp:Label></strong></td>
        <td> <asp:Label ID="Label10" runat="server"   Text='<%#Eval("cpdesig") %>'></asp:Label></td>
        </tr>
        <tr>
        <td><strong><asp:Label ID="Label13" runat="server" Text="Company Url"></asp:Label></strong></td>
        <td><asp:Label ID="Label14" runat="server"   Text='<%#Eval("comp_url") %>'></asp:Label> </td>
        </tr>
                <tr>
        <td><strong><asp:Label ID="Label15" runat="server" Text="Address for Communication"></asp:Label></strong></td>
        <td> <asp:Label ID="Label16" runat="server"   Text='<%#Eval("address") %>'></asp:Label></td>
        </tr>
        <tr>
         <td height="30"  style="background:url(images/regiterlinebg.png) repeat-x; color:Red">
         <b>Contact Details</b>
        ...
        <td>
        <asp:Label ID="Label18" runat="server"   Text='<%#Eval("w1_ccode") %>'></asp:Label>
        <asp:Label ID="Label23" runat="server"   Text='<%#Eval("w1_acode") %>'></asp:Label> 
        <asp:Label ID="Label24" runat="server"   Text='<%#Eval("w1_phone") %>'></asp:Label> 
        </td>
        </tr>
                <tr>
        ...
        <td>
        <asp:Label ID="Label22" runat="server"   Text='<%#Eval("street") %>'></asp:Label>,
        ...
        <td align="center" colspan="2">
          <asp:Button ID="btnEdit" runat="server" CommandArgument='<%#Eval("userid")%>' Text="Edit" OnClick="btnEdit_Click" />
        </td>
        </tr>
   ...
   <div class="innerright">
     <table width="100%" border="0">
       ...
       <tr>
         <td class="text" style="border-left:1px #A5B4FA  dashed; padding:10px;">
