<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="Vendor-Register.aspx.cs" Inherits="Vendor_Register" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="padding: 10px;">
        <div class="row">
            ...
            <div class="col-md-8">
                <br />
                <h2 style="text-align: center;">Vendor Registration</h2>
                <br />
                       <table width="100%" align="center">
                                ...
                                <tr>
                                    ...
                                    <td width="30%" align="left">
                                        <asp:TextBox ID="txtusername" runat="server" Width="250px"
                                            OnTextChanged="txtusername_TextChanged" AutoPostBack="true" CssClass="feed1"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td width="30%" align="left">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtconfirmpwd" ErrorMessage="*" ValidationGroup="vendor"></asp:RequiredFieldValidator>
                           ...
                           <tr><td height="2px">&nbsp;</td></tr>
                                ...
                                <tr>
                                    ...
                                    <td width="30%" align="left">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ErrorMessage="*" ControlToValidate="txtcompanymailid" ValidationGroup="vendor"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                           ...
                           <tr><td height="2px">&nbsp;</td></tr>
                                ...
                                <tr>
                                    <td height="30" colspan="4" style="background: url(images/regiterlinebg.png) repeat-x">
                                        <font class="crentopenings"><b>Company Information</b></font></td>
                                </tr>
                                <tr>
                                    <td width="30%" align="right">
                           ...
                           <tr><td height="2px">&nbsp;</td></tr>
                                ...
                                <tr>
                                    <td height="30" colspan="4" style="background: url(images/regiterlinebg.png) repeat-x"><font class="crentopenings"><b>
                           ...
                           <tr><td height="2px">&nbsp;</td></tr>
                                ...
                                <tr>
                                    ...
                                    <td width="10%" align="center"><strong>:</strong></td>
                                    <td width="30%" align="left">
                                        <asp:DropDownList ID="country" runat="server" CssClass="feed1" Width="250px"
                                    ...
                                    <td width="30%" align="left">
                                        <asp:RequiredFieldValidator ID="rfvcountry" runat="server"
                                            ...
                                            InitialValue="Select Country" Font-Size="Smaller" ValidationGroup="vendor">Please Select Country</asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                           <tr><td height="2px">&nbsp;</td></tr>
                                ...
                                <tr>
                                    ...
                                    <td width="10%" align="center"><strong>:</strong></td>
                                    <td width="30%" align="left">
                                        <asp:DropDownList ID="state" runat="server" CssClass="feed1" Width="250px" BorderWidth="1"
                                            OnSelectedIndexChanged="country_SelectedIndexChanged">
                                   ...
                                   <td width="30%" align="left">
                                        <asp:RequiredFieldValidator ID="rfvstate" runat="server"
                                            ...
                                            ControlToValidate="state" ValidationGroup="vendor">Please Select State</asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                           <tr><td height="2px">&nbsp;</td></tr>
                           ...
                           <tr><td height="2px">&nbsp;</td></tr>
                                ...
                                <tr>
                                    ...
                                    <td width="10%" align="center"><strong>:</strong></td>
                                    <td width="30%" align="left">
                                        <asp:TextBox ID="txtphone" runat="server" Width="250px" CssClass="feed1" MaxLength="11"></asp:TextBox>
                                    </td>
                                    <td width="30%" align="left">
                           ...
                           <tr><td height="2px">&nbsp;</td></tr>
                                ...
                                <tr>
                                    <td height="30" colspan="3" style="background: url(images/regiterlinebg.png) repeat-x">
                                        <font class="crentopenings"><b>
                                    Terms &amp; Conditions</b></font></td>
                                </tr>

                                <tr height="10px">
                                    <td colspan="4" align="left" valign="top" style="height: 15px" class="lable4">&nbsp;&nbsp;
                                  <table border="0">
                                      <tr>
                                          <td valign="top">
                                          ...
                                          <td width="100%">
                                              <p>
                                                  I have read and understood and agree to the <a href="#">Terms and Conditions</a>
                                            ...
                                            <tr>
                                                <td width="100%" align="center">
                                                    <asp:Button ID="btnsubmit" runat="server" Text="Submit"
                                                        OnClick="btnsubmit_Click" ValidationGroup="vendor" CssClass="btn btn-success"  />
                                                    <asp:Button ID="btnreset" runat="server" Text="Reset"
                                                        OnClick="btnreset_Click" CssClass="btn btn-danger" /></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
