<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Vendor_change_pwd.aspx.cs" Inherits="Vendor_change_pwd" %>
...
<a href="http://www.aceindus.in/new_employeeform.aspx">New Employee Form</a>
  ...
  <tr>
        <td class="style1"> Vendor Change Password :</td>
  </tr>
  <tr>
  <!-- start the DIV-->
       ...
       <tr>
        ...
        <tr>
          ...
          <td style="width: 249px; height: 20px;">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator55" runat="server" ControlToValidate="oldpassword" ErrorMessage="*" Font-Bold="True" Font-Size="Large" Width="7px"></asp:RequiredFieldValidator>
          </td>
        </tr>
        <tr>
            <td colspan="3" height="20px"></td>
