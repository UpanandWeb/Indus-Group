...
<li><a href="#" rel="dropmenu5">Academic</a></li>
  ...
  <td width="1000" align="center">
    ...
    <%--<tr align="center">
        <td align="center" style="font-size:14px; color:#036; font-family:Arial Black;">
            <asp:RadioButton ID="rb1india" runat="server" GroupName="group" Checked="true" Text="INDIA" AutoPostBack="true" 
                oncheckedchanged="rb1india_CheckedChanged" />
        </td>
       <%-- <td align="center" style="font-size:14px; color:#036; font-family:Arial Black;">
            <asp:RadioButton ID="rb2usa" runat="server" Text="USA" GroupName="group" AutoPostBack="true" 
                oncheckedchanged="rb2usa_CheckedChanged" />
        </td>
   </tr>--%>
</table>
<br />
...
<tr height="15" class="headings2">
      <td colspan="4" align="left" valign="top" bgcolor="#336699" style="height: 15px" ><span class="headings3">
      <font color="white"><strong>Contact Information:</strong></font> </span></td>
    </tr>
...
<tr height="15" class="headings2">
      <td colspan="4" align="left" valign="top" bgcolor="#336699" style="height: 15px" ><span class="headings3">
      <font color="white"><strong>Present Address:</strong></font></span></td>
    </tr>
...
<li><a href="job_seekers.html">Job Seekers</a></li>
