<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Vendor_forget_pwd.aspx.cs" Inherits="Vendor_forget_pwd" %>
...
<title>:: Ace Indus :: Client Forget Password.</title>
...
<table width="1014px" border="0" class="main">
  <tr>
    <td height="60" style="padding-left:10px"><table width="100%" border="0">
      <tr>
        <td width="25%" height="48" valign="middle"><a href="Default.aspx"><img src="images/logo.png" width="199" height="46" border="0"/></a></td>
        <td width="21%" align="left" style="padding-left:70px"><a href="#"><img src="images/iso1.png" width="131" height="60" style="border:none" /></a></td>
...
<a href="http://www.aceindus.in/new_employeeform.aspx">New Employee Form</a>
  ...
  <tr>
        <td class="style1"> Vendor Forget Password :</td>
  </tr>
  <tr>
  <!-- start the DIV-->
   ...
   <div class="innerleft">
        ...
        <tr>
            <td colspan="2" align="center" class="heading"  style=" background-image:url(images/yellowmenubg_1.jpg); background-repeat:repeat-x; border:1px; height:25px; font-weight:bold; color:#bc5441" valign="top">Forget Password</td>
        </tr>
        <tr bgcolor="f5f5f5">
