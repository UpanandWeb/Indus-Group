...
<div style="padding-left:10px ">
  ...
  <tr>
    <td width="41%"><font class="crentopenings">INDIA</font></td>
    <td width="7%"INDIA</font></td>
    <td width="52%" rowspan="9" valign="top">
    <table   style="background-color:#F4F4F4; border:1px solid #C7C7C7; padding:5px" cellspacing="2px" cellpadding="5px" height="439">
      <tr>
        <td colspan="4" align="center" class="heading"  style=" background-image:url(images/yellowmenubg_1.jpg); background-repeat:repeat-x; border:1px; height:25px; color:#036" valign="top">Contact Form </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td align="left" style="height:20px "><asp:TextBox ID="txtaddr" 
                TextMode="MultiLine" runat="server" Height="50px"></asp:TextBox></td>
