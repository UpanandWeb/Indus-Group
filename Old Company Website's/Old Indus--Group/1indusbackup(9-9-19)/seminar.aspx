...
<body class="home page page-id-476 page-template page-template-page-home page-template-page-home-php">
  ...
  <section class="about text-left" id="about">
    <div class="container">
     ...
     <asp:Image ID="corp1" runat="server" Width="100%"   ImageUrl="Images/seminar-banner.jpg"/></td></tr>
 <tr>
          ...
          <tr>
            ...
            <td width="863" align="right" valign="top" style="padding:10px;">
             <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="center" valign="top" class="head-black" width="100%" ><h3 style="color:#2471a3;">Seminars</h3></td>
              </tr>
              <tr>
              ...
              <tr>
                <td width="100%" style="padding-left:35px; padding:35px;"><h4>Indus Group is organizing a seminar on the following topics by industry experts at our Herndon office Virginia
             ...
             <tr><td align="justify" >
                     ...
                     <asp:DataList ID="dlopenings" runat="server" Width="100%">
                                <ItemTemplate>
                               <%--  <tr>
    <td height="22" align="left" valign="top" style=" background-repeat:no-repeat; background-position:center;"><img src="Images/spacer_igiit.png" width="5" height="10" /></td>
  </tr>--%>
  <tr>
  <td    style="background-color:#f1f1f1; width:100%; background-repeat:repeat-y; border-radius:10px; padding:10px; ">
  <h4>
  <table width="100%" cellpadding="6" border="0" cellspacing="3">
                                        <tr>
                                            <td width="10%"  style="padding-left:15px;">
                                                <span class="datanew">Course</span>
                                            </td>
                                            <td valign="middle" width="1%" class="datanew">
                                                <strong>&nbsp;:&nbsp;</strong>
                                            </td>
                                            <td width="83%" class="data" style="color:Red" > 
                                             
                                               <%-- <asp:Label ID="Label1" runat="server" Text='<%# Bind("CourseName") %>' CssClass="lable"></asp:Label></p>--%>
        <asp:HyperLink ID="HyperLink1" runat="server" ForeColor="Red"  CssClass="a" Target="_blank"  Text='<%#Eval("CourseName") %>' NavigateUrl='<%# "seminardesc.aspx?sid="+ Eval("sid") %>'></asp:HyperLink>
                                            </td>
                                        </tr>
                                       <%-- <tr>
                                            <td width="15%" style="padding-left:15px;">
                                                <span class="datanew">Date & Time</span>
                                            </td>
                                            <td width="1%" class="datanew">
                                               <strong>&nbsp;:&nbsp;</strong>
                                            </td>
                                            <td width="83%" class="data" style="color: blue">
                                                 <p  align="justify">
                                                <asp:Label ID="Label3" runat="server" Text='<%# Bind("SeDate") %>' CssClass="lable"></asp:Label></p>
                                            </td>
                                        </tr>--%>
                                        <tr>
                                            <td  width="10%" style="padding-left:13px;" valign="top">
                                               Description
                                            </td>
                                            <td width="1%" class="datanew" valign="top">
                                                <strong>&nbsp;:&nbsp;</strong>
                                            </td>
                                            <td width="83%" class="data" >
                                          
                                                <asp:Label ID="Label2" runat="server" Text='<%# Bind("CouserDes") %>' CssClass="lable"></asp:Label>
                                            </td>
                                        </tr>
                                         <tr>
                                            <td width="15%" style="padding-left:15px;">
                                                <span class="datanew"> Speaker</span>
                                            </td>
                                            <td width="1%" class="datanew">
                                                <strong>&nbsp;:&nbsp;</strong>
                                            </td>
                                            <td width="83%" class="data" style="color: Gray" >
                                           
                                                <asp:Label ID="Label4" runat="server" Text='<%# Bind("Sfacilityname") %>' CssClass="lable"></asp:Label>
                                            </td>
                                        </tr>
       ...
       <tr>
    <td height="22" style="background-image:url(Images/bottom_strip_igiit.png); background-repeat:no-repeat; background-position:center;">&nbsp;</td>
  </tr>
  <tr><td>&nbsp;</td></tr>
 ...
 <tr>
    ...
    <tr>
        <td align="left" style="padding-left:35px; padding-right:35px;">&nbsp;&nbsp;<asp:label id="lblCurrentPage" runat="server"></asp:label></td>
    </tr>  <tr><td align="center">Please send an email to resume@1indus.com for your registration.       </td></tr> 
