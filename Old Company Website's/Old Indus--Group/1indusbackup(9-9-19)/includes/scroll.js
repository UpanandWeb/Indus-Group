...
setTimeout(function(){scrollerinstance.animateup()}, 15)
}
else{
...
var ceiling=(this.content.length)/2
...
return window.getComputedStyle(tickerobj, "").getPropertyValue("padding-top:4px")
else
return 0
}
