                  ...
                  <tr>
                    <td style="background:url(Images/midiabg.png) repeat-x">
                      <table width="100%" border="0">
                             <tr><td width="3px">&nbsp;</td></tr>
                        <tr>
                        <td width="34%">Country</td>
                        <td width="4%" style="padding-left:1px"><strong>:</strong></td>
                        <td width="62%">
                            <asp:DropDownList ID="ddcontry" runat="server" Width="159px"   Height="30px"
                                >
                        ...
                        <td width="4%" style="padding-left:1px"><strong>:</strong></td>
                        <td width="62%">
                            <asp:DropDownList ID="ddllogin" runat="server" Width="159px" AutoPostBack="true"  Height="30px"
                      ...
                      <table width="100%" border="0" style="line-height:25px">
                        ...
                        <tr>
                            ...
                            <td><strong>:</strong></td>
                            <td width="63%">
                            <asp:TextBox ID="txtpwd" runat="server" Width="160px" TextMode="Password"></asp:TextBox>
                            ...
                            <tr>
                               ...
                               <asp:HyperLink ID="Hyperreg" Visible="false" NavigateUrl="newemp.aspx" runat="server">Register</asp:HyperLink>
                                ...
                                <td colspan="3" align="center" width="80%">
                                       <asp:CheckBox ID="chksign"  runat="server" Text="Keep me Signed in" />
                                </td>
                            </tr>
                            </table>
                        </asp:Panel>
