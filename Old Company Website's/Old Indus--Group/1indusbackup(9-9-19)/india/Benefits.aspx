        ...
        <td align="center" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td td width="180" valign="top" bgcolor="#EFEFEF" align="left"><table width="95%" border="0" align="right" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                  <tr>
                <td height="28" align="left" valign="middle" bgcolor="#DBDBDB"><span class="mainhead"><span class="head-black">&nbsp;&nbsp;</span><span class="head-black">Carrers</span></span></td>
              </tr>
                  </tr>
                </table></td>
              </tr>
              ...
              <tr>
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td align="left" valign="top" class="mainhead" ><a href="Careers.aspx" class="sublink">Overview</a></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
              ...
              <tr>
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="12" align="left" valign="middle"><img src="../Images/arrow-red.gif" width="4" height="8"></td>
                    <td align="left" valign="top" class="hd1"><a href="Benefits.aspx" style="font-weight:bold; color:Black;" class="sublink">Benefits</a></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
              ...
              <tr>
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="12" align="left" valign="middle"><img src="../Images/arrow-red.gif" width="4" height="8"></td>
                    <td align="left" valign="top" class="mainhead"><a href="seminar.aspx" class="sublink">Seminars</a></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
            ...
            <td width="863" align="right" valign="top" style="padding:10px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="left" valign="top" class="head-black"><h3 style="color:#2471a3;">Benefits</h3>	<span class="head-red"></span></td>
              </tr>
              <tr>
...
We maintain an &ldquo;open door&rdquo; policy, and   encourage   employees to   make suggestions that may aid in our continuous     improvement and   welcome employees who enjoy challenging assignments and     constantly   strive for a higher standard of professionalism.
  ...
  <h3>Flexible Spending   Plan</h3>
                    <h4>All employees are eligible to participate in our   Flexible     Spending Plan. Under this plan, you may put aside pre-tax   money to use   to pay   for medical expenses that are not covered by     insurance.</h4>
  
  <h3>401(k) Retirement Savings Plan/Tax   Benefit</h3> 
  <h4>Employees are eligible to participate   in our 401(k) plan at     date of hire. They may contribute up to 15% of their   salary on a     tax-deferred basis up to the annual maximum set by the IRS.   Employees     are able to choose among a wide variety of investment options in order       to achieve their personal financial goals. The tax benefits of the   plan   are   excellent as well.</h4>
  ...
  <h3>Permanent Residence or Green Card</h3>
                  ...
                  <h4>For details on the prospective client referral program please contact</h4> <a href="mailto:sales@igiit.net"><strong>sales@</strong></a><a href="mailto:info@igiit.net?subject=Info"><strong>1indus.com</strong></a> or call us @   1-703-957-7829 <br>
                    <br>
                   <h4> For details on the referral program for prospective   employees please contact </h4><a href="mailto:resume@igiit.net"><strong>resume@</strong></a><a href="mailto:info@igiit.net?subject=Info"><strong>1indus.com </strong></a>or call us   @ 1-703-957-7829 </p>
