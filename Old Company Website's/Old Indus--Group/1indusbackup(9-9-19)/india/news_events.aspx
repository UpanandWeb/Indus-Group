  ...
  <div style="height:10px;"></div>
   <section class="about text-left" id="about">
        ...
        <table height="650px" width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="863" align="right" valign="top" style="padding:10px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="left" valign="top" class="head-black" width="100%" ><h3 style="color:#2471a3;">News & Events</h3></td>
              </tr>
              <tr>
    ...
    <PagerStyle CssClass="GridviewScrollPager" HorizontalAlign="Right"/> 
           ...
           <%--   <tr>
                <td height="400" align="justify" valign="top" width="100%" style="padding-left:35px;padding-right:35px;">
                    <div align="justify">
                      <asp:DataList ID="dlopenings" runat="server" Width="100%">
                            <ItemTemplate>
                                <table width="100%" cellpadding="6" cellspacing="3">
                                    <tr>
                                        <td width="15%">
                                            <span class="datanew">Title</span>
                                        </td>
                                        <td width="1%" class="datanew">
                                            :
                                        </td>
                                        <td width="83%" class="data" style="color: Red">
                                            <asp:Label ID="Label1" runat="server" Text='<%# Bind("jobtitle") %>' CssClass="lable"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="15%">
                                            <span class="datanew">Description</span>
                                        </td>
                                        <td width="1%" class="datanew">
                                            :
                                        </td>
                                        <td width="83%" class="data">
                                            <asp:Label ID="Label2" runat="server" Text='<%# Bind("jobdesc") %>' CssClass="lable"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="83%" class="data" style="color: Red">
                                            <asp:Label ID="Label3" runat="server" Text='<%# Bind("sdate") %>' CssClass="lable"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" height="30px"><hr /></td>
                                    </tr>
                                </table>
                            </ItemTemplate>
                      </asp:DataList>
               ...
               <tr>
    <td align="center">&nbsp;&nbsp;<asp:Button id="cmdPrev" runat="server" Text=" Prev " OnClick="cmdPrev_Click" ForeColor="Blue"></asp:Button>
        &nbsp;<asp:Button id="cmdNext" runat="server" Text=" Next " OnClick="cmdNext_Click" ForeColor="Blue"></asp:Button></td>
    </tr>
    <tr>
        <td>&nbsp;&nbsp;<asp:label id="lblCurrentPage" runat="server"></asp:label></td>
              ...
              <%--<tr>
                <td align="center">
                    <table border="0" style="background-color: #D5E6F9; width:5%; margin-right: 0px;
