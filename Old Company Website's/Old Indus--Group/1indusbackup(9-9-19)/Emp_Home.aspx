...
<body >
   ...
   <div class="container-fluide header-inner-wrap">
    <%--<head:Header ID="Header1" runat="server"></head:Header>--%>
     ...
     <table width="95%"   cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" align="center" >
       <tr>
        <td colspan="3" align="center" style="height:53px">
            <h2 color="#0e4860">
                <b>Indus Group Employee Control</b>
            </h2> 
        </td>
       </tr>
         <tr><td><br /></td></tr>
       ...
       <tr>
           <td align="left" style="width: 783px; height: 23px; color:Maroon; font-size:15px; font-weight:bold" valign="top">
               Employee Form:</td>
           <td valign="top">&nbsp;:&nbsp;</td>
       ...
       <tr>
        <td align="left" valign="top" class="lblog" style="width: 783px; height: 69px; color:Maroon; font-size:15px; font-weight:bold">
         Upload Forms
        </td>
        <td valign="top">&nbsp;:&nbsp;</td>
     ...
     <tr>
        <td align="left" valign="top" class="lblog" style="width: 783px; color:Maroon; font-size:15px; font-weight:bold">
