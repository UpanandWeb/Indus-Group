...
<body class="home page page-id-476 page-template page-template-page-home page-template-page-home-php">
  ...
  <div style="height:10px;"></div>
    ...
    <div class="container">
     ...
     <asp:Image ID="corp1" runat="server" Width="100%"   ImageUrl="Images/management-1.jpg"/></td></tr>
 <tr>
        <td   height="650px" align="center" valign="top"><table  height="650px" width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <tr>
                <td height="16" align="left" valign="top"><img src="Images/spacer.gif" alt="Spacer" width="1" height="2"></td>
              </tr>
              <tr>
                <td align="center" valign="top" class="head-black" width="100%"><h3 style="color:#2471a3;">Management</h3> <span class="head-red"></span></td>
              </tr>
              <tr>
              ...
              <tr>
                <td height="400" align="justify" valign="top" width="100%" ><h3>Our Team:</h3>
                <h4> Our Management team consists of Stalwarts who have got a huge amount of real-time experience in Software project management, Handling Global
                     Business Units, tackling Complex IT Problem solving issues and also  maintaining an effective global network of relevant professionals, 
                    who have time and again proved their mettle by helping us in any organizational issue arising out of inadequacy or any other company related hassle.
                Our agenda when it comes to both Micro as well as Macro management is to see that ultimately all the different work processes
                     that we follow are in line with our customer requirements, thereby building a bridge of trust and commitment coupled with quality and delivery aspects.</h4>
