<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Top1.ascx.cs" Inherits="UControls_Top" %>
    ...
    <div class="" style="">
        <div class="topmenu row hidden-xs" style="background-color: #052e70; padding: 3px 0 0px 12%">
            ...
            <nav class=" col-md-offset-4 col-lg-offset-6 col-sm-9 col-md-5 col-lg-0   top-width " style="padding-right: 0px">
                ...
                <a href="http://www.facebook.com/" style="margin-left: 10%;"><i class="fa fa-facebook"></i></a>
        ...
        <div class="row">
            <div class="col-lg-2 col-md-2 col-sm-5"><a href="Default.aspx" id="logo">
                <img class="logo" src="img/logo.png" alt="" width="280px" height="60px"></a>	</div>
            ...
            <div class="col-lg-1 col-md-1 col-sm-1 hidden-xs"><a href="index####" id="A1">
                <img class="iso " src="img/iso.png" alt=""></a>	</div>
        </div>
    </div>
</header>
