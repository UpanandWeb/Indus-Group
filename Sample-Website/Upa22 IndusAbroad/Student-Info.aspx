<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="Student-Info.aspx.cs" Inherits="Student_Info" %>
                            ...
                            <table width="100%" align="center">
                                <tr height="15">
                                    <td width="100%" align="center">
                                        <table width="100%" align="center" colspan="8">
                                            <tr>
                                            ...
                                            <tr>
                                                <td align="right" width="15%" class="headings2">Title3 :<span style="color: red">*</span> &nbsp;&nbsp;
                                                </td>
                                                <td align="left" width="18%">
                                                    <asp:TextBox ID="TextBox7" runat="server" MaxLength="50" Width="180px"></asp:TextBox>
                                                </td>

                                                <td align="right" width="15%" class="headings2">Title4 :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                <td align="left" width="18%">&nbsp;&nbsp;   
                                                    <asp:TextBox ID="TextBox8" runat="server" MaxLength="50" Width="180px"></asp:TextBox>
                                                </td>

                                                <td align="right" width="15%" class="headings2"></td>
                                            ...
                                            <tr>
                                                <td align="right" width="15%" class="headings2">Email ID :<span style="color: red">*</span> &nbsp;&nbsp;
                                                </td>
                                                <td align="left" width="18%">
                                                    <asp:TextBox ID="txtemail" runat="server" MaxLength="50" Enabled="false" Width="180px"></asp:TextBox>
                                                </td>

                                                <td align="right" width="15%" class="headings2">Alternate Email :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                <td align="left" width="18%">&nbsp;&nbsp;   
                                                    <asp:TextBox ID="conemail" runat="server" MaxLength="50" Enabled="false" Width="180px"></asp:TextBox>
                                                </td>

                                                <td align="right" width="15%" class="headings2">Emp ID :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                <td align="left" width="18%">&nbsp;&nbsp;  
                                            ...
                                            <tr>
                                                <td align="right" width="15%" class="headings2">First Name :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                <td align="left" width="18%">&nbsp;&nbsp; 
                                                ...
                                                <td align="right" width="15%" class="headings2">Middle Name :&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="right" width="15%" class="headings2">Last Name :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                            ...
                                            <tr>
                                                <td align="right" width="15%" class="headings2">Gender :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="right" width="15%" class="headings2">Nationality :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="right" width="15%" class="headings2">Marital Status :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                <td align="left" width="18%">&nbsp;&nbsp;       
                                            ...
                                            <tr>
                                                <td align="right" width="15%" class="headings2">Birth Date : <span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="right" width="15%" class="headings2">Birth Country :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="right" width="15%" class="headings2">Birth State :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                            ...
                                            <tr>
                                                <td align="right" width="15%" class="headings2">Birth City :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="right" width="15%" class="headings2">Citizenship :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="right" width="15%" class="headings2">Passport No :<span style="color: red">*</span>&nbsp;&nbsp;
                                            ...
                                            <tr>
                                                <td align="right" width="15%" class="headings2">Issued at : <span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="left" width="18%">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="Requiredfieldvalidator13a" runat="server" ControlToValidate="pcountry" Display="Dynamic"
                                                        ErrorMessage="Select Country" InitialValue="Select Country" ValidationGroup="emp" ForeColor="Red" SetFocusOnError="true">*</asp:RequiredFieldValidator>
                                                </td>

                                                <td align="right" width="15%" class="headings2">Issued Date : <span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="right" width="15%" class="headings2">Expiry Date :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td align="right" width="15%" class="headings2">Issued Location : <span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>

                                                <td align="left" width="18%">
                                                    <asp:TextBox ID="plocation" runat="server" MaxLength="250" Width="180px" TabIndex="12"></asp:TextBox>
                                                    &nbsp;&nbsp;   <%-- <asp:Dropdownlist ID="Dropdownlist1" runat="server" CssClass="textfield" Width="180px"  BorderWidth="1" TabIndex="12" >
                                                     <asp:ListItem Value="Select Country">Select Country</asp:ListItem>
                                                     </asp:Dropdownlist>--%>
                                                    <%--<cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender9" runat="server" InvalidChars="1234567890/~`!@#$%^&*()_=+<>,."
                                                                    ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz" TargetControlID="pcountry">
                                                ...
                                                <td align="right" width="15%" class="headings2">Father Name :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="right" width="15%" class="headings2">Mother Name :<span style="color: red">*</span>&nbsp;&nbsp;
                                            ...
                                            <tr>
                                                <td colspan="8" align="left" valign="top" bgcolor="#336699" style="height: 18px">
                                                    <b><span class="headings3">Family Details</span> </b></td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="right" width="15%" class="headings2">Spouse Name :&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="right" width="15%" class="headings2">Birth Date :&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="right" width="15%" class="headings2">Gender :&nbsp;&nbsp;
                                                </td>
                                            ...
                                            <tr>
                                                <td align="right" width="15%" class="headings2">Chid Name1 :&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="right" width="15%" class="headings2">Child Name2 :&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="right" width="15%" class="headings2">Child Name3 :&nbsp;&nbsp;
                                                </td>
                                            ...
                                            <tr>
                                                <td align="right" width="15%" class="headings2">Gender :  &nbsp&nbsp;
                                                </td>

                                                <td align="left" width="18%">&nbsp&nbsp;    
                                                    <asp:RadioButton ID="k1gen1" runat="server" Text="Male" TabIndex="23" GroupName="c1" Font-Size="12px" />
                                                ...
                                                <td align="left" width="18%">&nbsp&nbsp;  
                                                    <asp:RadioButton ID="k2gen1" runat="server" Text="Male" TabIndex="24" GroupName="d1" Font-Size="12px" />
                                                ...
                                                <td align="left" width="18%">&nbsp&nbsp;   
                                                    <asp:RadioButton ID="k3gen1" runat="server" Text="Male" TabIndex="25" GroupName="e1" Font-Size="12px" />
                                            ...
                                            <tr>
                                                <td align="right" width="15%" class="headings2">Birth Date : &nbsp&nbsp;

                                                </td>

                                                <td align="left" width="18%">&nbsp&nbsp;   
                                                    <asp:TextBox ID="k1bd" runat="server" MaxLength="50" Width="180px" TabIndex="26"></asp:TextBox>
                                                ...
                                                <td align="left" width="18%">&nbsp&nbsp;     
                                                    <asp:TextBox ID="k2bd" runat="server" MaxLength="50" Width="180px" TabIndex="27"></asp:TextBox>
                                                ...
                                                <td align="left" width="18%">&nbsp&nbsp;   
                                                    <asp:TextBox ID="k3bd" runat="server" MaxLength="50" Width="180px" TabIndex="28"></asp:TextBox>
                                            ...
                                            <tr>
                                                <td colspan="8" align="left" valign="top" bgcolor="#336699" style="height: 18px">
                                                    <b><span class="headings3">Communication Details</span> </b></td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="right" width="15%" class="headings2">Country :<span style="color: red">*</span> &nbsp; &nbsp; 
                                                </td>
                                                ...
                                                <td align="right" width="15%" class="headings2">State :<span style="color: red">*</span>&nbsp; &nbsp; 
                                                </td>
                                                ...
                                                <td align="right" width="15%" class="headings2">City :<span style="color: red">*</span>&nbsp; &nbsp; 
                                                </td>
                                            ...
                                            <tr>
                                                <td align="right" width="15%" class="headings2">Street :<span style="color: red">*</span>&nbsp; &nbsp; 
                                                </td>
                                                ...
                                                <td align="left" width="18%">&nbsp; &nbsp;     
                                                    ...
                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender23" runat="server" InvalidChars="/~`!@#$%^&*()_=+<>,."
                                                        ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz " TargetControlID="street">
                                                    </cc1:FilteredTextBoxExtender>
                                                </td>

                                                <td align="right" width="15%" class="headings2">Door Number  :<span style="color: red">*</span> &nbsp; &nbsp; 
                                                </td>
                                                ...
                                                <td align="right" width="15%" class="headings2">Zip :<span style="color: red">*</span>&nbsp; &nbsp; 
                                                </td>
                                                ...
                                                <td align="left" width="18%">&nbsp; &nbsp;  
                                                    ...
                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender27" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz~`!@#$%^&*()_=+<>,.-/"
                                                        ValidChars="1234567890" TargetControlID="zip">
                                                    </cc1:FilteredTextBoxExtender>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td colspan="82" align="left" valign="top" bgcolor="#336699" style="height: 18px">
                                                    <b><span class="headings3">Contact Details</span> </b></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" width="18%">&nbsp; &nbsp;    
                                                    ...
                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender28" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz~`!@#$%^&*()_=+<>,.-/"
                                                        ValidChars="1234567890" TargetControlID="wp1">
                                                    </cc1:FilteredTextBoxExtender>
                                                    -
                                                    ...
                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender29" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz~`!@#$%^&*()_=+<>,.-/"
                                                        ValidChars="1234567890" TargetControlID="wp2">
                                                    </cc1:FilteredTextBoxExtender>
                                                    -
                                                    ...
                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender30" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz~`!@#$%^&*()_=+<>,.-/"
                                                        ValidChars="1234567890" TargetControlID="wp3">
                                                    </cc1:FilteredTextBoxExtender>
                                                </td>
                                                <td align="right" width="15%" class="headings2">Ph:Home : <span style="color: red">*</span> &nbsp; &nbsp; 
                                                </td>
                                                <td align="left" width="18%">&nbsp; &nbsp;  
                                                    ...
                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender31" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz~`!@#$%^&*()_=+<>,.-/"
                                                        ValidChars="1234567890" TargetControlID="hp1">
                                                    </cc1:FilteredTextBoxExtender>
                                                    ...
                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender32" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz~`!@#$%^&*()_=+<>,.-/"
                                                        ValidChars="1234567890" TargetControlID="hp2">
                                                    </cc1:FilteredTextBoxExtender>
                                                    ...
                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender33" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz~`!@#$%^&*()_=+<>,.-/"
                                                        ValidChars="1234567890" TargetControlID="hp3">
                                                    </cc1:FilteredTextBoxExtender>
                                                </td>

                                                <td align="right" width="15%" class="headings2">Mobile :<span style="color: red">*</span>&nbsp; &nbsp; 
                                                </td>
                                                <td align="left" width="18%">&nbsp; &nbsp;     
                                                    ...
                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender34" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz~`!@#$%^&*()_=+<>,.-/"
                                                        ValidChars="1234567890" TargetControlID="mb1">
                                                    </cc1:FilteredTextBoxExtender>
                                                    ...
                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender35" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz~`!@#$%^&*()_=+<>,.-/"
                                                        ValidChars="1234567890" TargetControlID="mb2">
                                                    </cc1:FilteredTextBoxExtender>
                                                    ...
                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender36" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz~`!@#$%^&*()_=+<>,.-/"
                                                        ValidChars="1234567890" TargetControlID="mb3">
                                                    </cc1:FilteredTextBoxExtender>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td colspan="8" align="left" valign="top" bgcolor="#336699" style="height: 18px">
                                                    <b><span class="headings3">Bank Account Details</span> </b></td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="right" width="15%" class="headings2">Account Name :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="right" width="15%" class="headings2">Account Number :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="right" width="15%" class="headings2">Bank Name :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                            ...
                                            <tr>
                                                <td align="right" width="15%" class="headings2">Branch Address :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="right" width="15%" class="headings2">IFSC CODE :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="right" width="15%" class="headings2">Swift Code :<%--<span style="color:red">*</span>--%>&nbsp;&nbsp;
                                                </td>
                                           ...
                                           ErrorMessage="Provide Home Number" ValidationGroup="emp" ForeColor="Red"  SetFocusOnError="true" >*</asp:RequiredFieldValidator>--%>
                                            ...
                                            <tr>
                                                <td align="right" width="15%" class="headings2">Address In Your Bank Account :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                            ...
                                            <tr>
                                                <td colspan="8" align="left" valign="top" bgcolor="#336699" style="height: 18px">
                                                    <b><span class="headings3">Identification Details 
                                                    </span></b>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="right" width="15%" class="headings2">Adhar Number :<span style="color: red">*</span> &nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="right" width="15%" class="headings2">Adhar Issue Place :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="right" width="15%" class="headings2">Adhar Issue City :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                            ...
                                            <tr>
                                                <td align="right" width="15%" class="headings2">Pan Number :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="right" width="15%" class="headings2">Pan issue Place<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="right" width="15%" class="headings2">Pan issue city :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                            ...
                                            <tr>
                                                <td align="right" width="15%" class="headings2">Licence Number :<%--<span style="color: red">*</span>--%>&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="right" width="15%" class="headings2">Issue Place :<%--<span style="color: red">*</span>--%>&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="right" width="15%" class="headings2">Issue city :<%--<span style="color: red">*</span>--%>&nbsp;&nbsp;
                                                </td>
                                            ...
                                            <tr>
                                                <td colspan="8" align="left" valign="top" bgcolor="#336699" style="height: 18px">
                                                    <b><span class="headings3">Emergency Contact Details
                                                    </span></b>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="right" width="15%" class="headings2">Cont.Person-1 :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="left" width="18%">&nbsp;&nbsp;   
                                                    ...
                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender47" runat="server" InvalidChars="1234567890~`!@#$%^&*()_=+<>,.-/"
                                                        ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz " TargetControlID="cpname1">
                                                    </cc1:FilteredTextBoxExtender>
                                                </td>
                                                <td align="right" width="15%" class="headings2">Phone Number :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="left" width="18%">&nbsp;&nbsp;    
                                                    ...
                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender49" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ~`!@#$%^&*()_=+<>,.-/"
                                                        ValidChars="1234567890" TargetControlID="cpphone1">
                                                    </cc1:FilteredTextBoxExtender>
                                                </td>
                                                <td align="right" width="15%" class="headings2">Email ID :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                            ...
                                            <tr>
                                                <td align="right" width="15%" class="headings2">Address :<span style="color: red">*</span>&nbsp;&nbsp;
                                                ...
                                                <td align="left" width="18%">&nbsp;&nbsp;    
                                                    ...
                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender52" runat="server" InvalidChars="~`!@#$%^&*()_=+<>."
                                                        ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz 1234567890/-," TargetControlID="cpaddr1">
                                                    </cc1:FilteredTextBoxExtender>
                                                </td>
                                            ...
                                            <tr>
                                                <td align="right" width="15%" class="headings2">Cont.Person-2 :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                <td align="left" width="18%">&nbsp;&nbsp;   
                                                    ...
                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender48" runat="server" InvalidChars="1234567890~`!@#$%^&*()_=+<>,.-/"
                                                        ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz " TargetControlID="cpname2">
                                                    </cc1:FilteredTextBoxExtender>
                                                </td>
                                                <td align="right" width="15%" class="headings2">Phone Number : <span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="left" width="18%">&nbsp;&nbsp;    
                                                    ...
                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender50" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ~`!@#$%^&*()_=+<>,.-/"
                                                        ValidChars="1234567890" TargetControlID="cpphone2">
                                                    </cc1:FilteredTextBoxExtender>
                                                </td>
                                                <td align="right" width="15%" class="headings2">Email ID :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" width="18%">&nbsp;&nbsp;   
                                                    ...
                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender51" runat="server" InvalidChars="~`!@#$%^&*()_=+<>."
                                                        ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz 1234567890/-," TargetControlID="cpaddr2">
                                                    </cc1:FilteredTextBoxExtender>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td colspan="8" align="left" valign="top" bgcolor="#336699" style="height: 18px">
                                                    <b><span class="headings3">Technical Experience
                                                    </span></b>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="right" width="15%" class="headings2">Exp Years &amp; Months :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="left" width="18%">&nbsp;&nbsp;    
                                                    ...
                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender56" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ~`!@#$%^&*()_=+<>,./-"
                                                        ValidChars="1234567890" TargetControlID="expyrs">
                                                    </cc1:FilteredTextBoxExtender>
                                                    ...
                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender55" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ~`!@#$%^&*()_=+<>,./-"
                                                        ValidChars="1234567890" TargetControlID="expmon">
                                                    </cc1:FilteredTextBoxExtender>
                                                    <span class="headings2">Months</span>
                                                </td>
                                                <td align="right" width="15%" class="headings2">Functional Area :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="left" width="18%">&nbsp;&nbsp; 
                                                    ...
                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender53" runat="server" InvalidChars="~`!@#$%^&*()_=+<>,.1234567890/-"
                                                        ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz " TargetControlID="fnarea">
                                                    </cc1:FilteredTextBoxExtender>
                                                </td>

                                                <td align="right" width="15%" class="headings2">Current Industry :<span style="color: red">*</span>&nbsp;&nbsp;
                                                </td>
                                                ...
                                                <td align="left" width="18%">&nbsp;&nbsp;      
                                                    ...
                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender54" runat="server" InvalidChars="~`!@#$%^&*()_=+<>,./-"
                                                        ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz 1234567890" TargetControlID="currind">
                                                    </cc1:FilteredTextBoxExtender>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td colspan="8" align="left" valign="top" bgcolor="#336699" style="height: 18px">
                                                    <b><span class="headings3">Technical Skills
                                                    </span></b>
                                                </td>
                                            </tr>
                                                ...
                                                <td colspan="6" width="100%" align="center">
                                                    <table width="100%" align="center">
                                                        <tr id="trskills1" runat="server">
                                                            <td align="right" width="15%" class="headings2">Skills-1 :<span style="color: red">*</span> &nbsp;&nbsp;
                                                            </td>
                                                            <td align="left" width="18%">&nbsp;&nbsp;  
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender83" runat="server" InvalidChars="~`!@$%^&*()_=+<>,/-"
                                                                    ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz.1234567890# " TargetControlID="skills1">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>

                                                            <td align="right" width="10%" class="headings2">No of Years :<span style="color: red">*</span>&nbsp;&nbsp;
                                                            </td>
                                                            <td align="left" width="6%">&nbsp;&nbsp;  
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender57" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ~`!@#$%^&*()_=+<>,./-"
                                                                    ValidChars="1234567890" TargetControlID="sk1yrs">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>

                                                            <td align="right" width="10%" class="headings2">No Of Months :<span style="color: red">*</span>&nbsp;&nbsp;
                                                            </td>
                                                            <td align="left" width="6%">&nbsp;&nbsp;       
                                                            ...
                                                            <td align="right" width="15%" class="headings2">Expert Level : <span style="color: red">*</span>&nbsp;&nbsp;
                                                        ...
                                                        <tr id="trskills2" runat="server">
                                                            <td align="right" width="15%" class="headings2">Skills-2 :<span style="color: red">*</span>&nbsp;&nbsp;
                                                            ...
                                                            <td align="left" width="18%">&nbsp;&nbsp;   
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender84" runat="server" InvalidChars="~`!@$%^&*()_=+<>,/-"
                                                                    ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz.1234567890# " TargetControlID="skills2">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td align="right" width="10%" class="headings2">No of Years :<span style="color: red">*</span>&nbsp;&nbsp;
                                                            ...
                                                            <td align="left" width="6%">&nbsp;&nbsp;  
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender59" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ~`!@#$%^&*()_=+<>,./-"
                                                                    ValidChars="1234567890" TargetControlID="sk2yrs">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td align="right" width="10%" class="headings2">No of Months :<span style="color: red">*</span>&nbsp;&nbsp;
                                                        ...
                                                        <tr id="trskills3" runat="server">
                                                            <td align="right" width="15%" class="headings2">Skills-3 : &nbsp;&nbsp;
                                                            ...
                                                            <td align="left" width="18%">&nbsp;&nbsp;    
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender85" runat="server" InvalidChars="~`!@$%^&*()_=+<>,/-"
                                                                    ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz.1234567890# " TargetControlID="skills3">
                                                                </cc1:FilteredTextBoxExtender>
                                                 ...
                                                 ErrorMessage="Provide Skill 3" ValidationGroup="emp" ForeColor="Red"  SetFocusOnError="true" >*</asp:RequiredFieldValidator>--%>
                                                            ...
                                                            <td align="right" width="10%" class="headings2">No of Years :&nbsp;&nbsp;
                                                            </td>
                                                            ...
                                                            <td align="left" width="6%">&nbsp;&nbsp;  
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender61" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ~`!@#$%^&*()_=+<>,./-"
                                                                    ValidChars="1234567890" TargetControlID="sk3yrs">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td align="right" width="10%" class="headings2">No of Months: &nbsp;&nbsp;
                                                            </td>
                                                            ...
                                                            <td align="right" width="15%" class="headings2">Expert Level : &nbsp;&nbsp;
                                                            </td>
                                                        ...
                                                        <tr id="trskills4" runat="server">
                                                            <td align="right" width="15%" class="headings2">Skills-4 : &nbsp;&nbsp;
                                                            </td>
                                                            <td align="left" width="18%">&nbsp;&nbsp; 
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender86" runat="server" InvalidChars="~`!@$%^&*()_=+<>,/-"
                                                                    ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz.1234567890# " TargetControlID="skills4">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            ...
                                                            <td align="left" width="6%">&nbsp;&nbsp;  
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender63" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ~`!@#$%^&*()_=+<>,./-"
                                                                    ValidChars="1234567890" TargetControlID="sk4yrs">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                        ...
                                                        <tr id="trskills5" runat="server">
                                                            <td align="right" width="15%" class="headings2">Skills-5 : &nbsp;&nbsp;
                                                            </td>
                                                            ...
                                                            <td align="left" width="18%">&nbsp;&nbsp;     
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender87" runat="server" InvalidChars="~`!@$%^&*()_=+<>,/-"
                                                                    ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz.1234567890# " TargetControlID="skills5">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td align="right" width="10%" class="headings2">No of Years :&nbsp;&nbsp;
                                                            </td>
                                                            ...
                                                            <td align="left" width="6%">&nbsp;&nbsp;     
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender65" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ~`!@#$%^&*()_=+<>,./-"
                                                                    ValidChars="1234567890" TargetControlID="sk5yrs">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td align="right" width="10%" class="headings2">No of Months : &nbsp;&nbsp;
                                                            </td>
                                                            ...
                                                            <td align="right" width="15%" class="headings2">Expert Level : &nbsp;&nbsp;</td>
                                                        ...
                                                        <tr id="trskills6" runat="server">
                                                            <td align="right" width="15%" class="headings2">Skills-6 : &nbsp;&nbsp;
                                                            </td>
                                                            ...
                                                            <td align="left" width="6%">&nbsp;&nbsp;  
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender67" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ~`!@#$%^&*()_=+<>,./-"
                                                                    ValidChars="1234567890" TargetControlID="sk6yrs">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td align="right" width="10%" class="headings2">No of Months : &nbsp;&nbsp;
                                                            </td>
                                                    ...
                                                    <table width="100%" align="center">
                                                        <tr>
                                                            <td align="left" valign="top" bgcolor="#336699" style="height: 18px" colspan="10">
                                                                <b><span class="headings3">Education Details
                                                                </span></b>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr id="tredu1" runat="server">
                                                            <td align="right" width="10%" class="headings2">PG : &nbsp;&nbsp;<%--<span style="color: red">*</span>--%>
                                                            </td>
                                                            ...
                                                            <td align="left" width="10%">&nbsp;&nbsp;  
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender95" runat="server" InvalidChars=".1234567890 ~`!@#$%^&*()_=+<>,/-"
                                                                    ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz" TargetControlID="edu1">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>

                                                            <td align="right" width="13%" class="headings2">Board/University : &nbsp;&nbsp;<%--<span style="color: red">*</span>--%></td>
                                                            ...
                                                            <td align="left" width="10%">&nbsp;&nbsp;    
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender96" runat="server" InvalidChars=".1234567890~`!@#$%^&*()_=+<>,/-"
                                                                    ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz " TargetControlID="ed1brd">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>

                                                            <td align="right" width="10%" class="headings2">Major in :&nbsp;&nbsp;<%--<span style="color: red">*</span>--%></td>
                                                            ...
                                                            <td align="left" width="11%">&nbsp;&nbsp;  
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender97" runat="server" InvalidChars=".1234567890~`!@#$%^&*()_=+<>/-"
                                                                    ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ," TargetControlID="ed1sub">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>

                                                            <td align="right" width="12%" class="headings2">Year Of&nbsp; Pass : &nbsp;&nbsp;
                                                            ...
                                                            <td align="left" width="10%">&nbsp;&nbsp;  
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender69" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ~`!@#$%^&*()_=+<>,./-"
                                                                    ValidChars="1234567890" TargetControlID="ed1yr">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>

                                                            <td align="right" width="4%" class="headings2">(%): &nbsp;&nbsp;<%--<span style="color: red">*</span>--%>
                                                            ...
                                                            <td align="left" width="10%">&nbsp;&nbsp; 
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender70" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ~`!@#$%^&*()_=+<>,/-"
                                                                    ValidChars="1234567890." TargetControlID="ed1per">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr id="tredu2" runat="server">
                                                            <td align="right" width="10%" class="headings2">Graduation : <span style="color: red">*</span>&nbsp;&nbsp; 
                                                            </td>
                                                            ...
                                                            <td align="left" width="10%">&nbsp;&nbsp;   
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender98" runat="server" InvalidChars=".1234567890 ~`!@#$%^&*()_=+<>,/-"
                                                                    ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz" TargetControlID="edu2">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td align="right" width="13%" class="headings2">Board/University :<span style="color: red">*</span>&nbsp;&nbsp; 
                                                            </td>
                                                            ...
                                                            <td>&nbsp;&nbsp;  
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender99" runat="server" InvalidChars=".1234567890~`!@#$%^&*()_=+<>,/-"
                                                                    ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz " TargetControlID="ed2brd">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td align="right" width="11%" class="headings2">Major in :<span style="color: red">*</span>
                                                            </td>
                                                            ...
                                                            <td>&nbsp;&nbsp;      
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender100" runat="server" InvalidChars=".1234567890~`!@#$%^&*()_=+<>/-"
                                                                    ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ," TargetControlID="ed2sub">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td align="right" width="12%" class="headings2">Year Of&nbsp; Pass :<span style="color: red">*</span> &nbsp;&nbsp; 
                                                            ...
                                                            <td>&nbsp;&nbsp;     
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender71" runat="server" InvalidChars=".ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ~`!@#$%^&*()_=+<>,/-"
                                                                    ValidChars="1234567890" TargetControlID="ed2yr">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td align="right" width="4%" class="headings2">(%): <span style="color: red">*</span> &nbsp;&nbsp; 
                                                            ...
                                                            <td>&nbsp;&nbsp;    
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender72" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ~`!@#$%^&*()_=+<>,/-"
                                                                    ValidChars="1234567890." TargetControlID="ed2per">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr id="tredu3" runat="server">
                                                            <td align="right" width="10%" class="headings2">UG :<span style="color: red">*</span> &nbsp;&nbsp; 
                                                            </td>
                                                            ...
                                                            <td>&nbsp;&nbsp;    
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender101" runat="server" InvalidChars=".1234567890 ~`!@#$%^&*()_=+<>,/-"
                                                                    ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz" TargetControlID="edu3">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td align="right" width="13%" class="headings2">Board/University :<span style="color: red">*</span> &nbsp;&nbsp; 
                                                            </td>
                                                            ...
                                                            <td>&nbsp;&nbsp;    
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender102" runat="server" InvalidChars=".1234567890~`!@#$%^&*()_=+<>,/-"
                                                                    ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz " TargetControlID="ed3brd">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td align="right" width="11%" class="headings2">Major in :<span style="color: red">*</span> &nbsp;&nbsp; 
                                                            ...
                                                            <td>&nbsp;&nbsp;       
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender103" runat="server" InvalidChars=".1234567890~`!@#$%^&*()_=+<>/-"
                                                                    ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ," TargetControlID="ed3sub">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td align="right" width="12%" class="headings2">Year Of&nbsp; Pass:<span style="color: red">*</span> &nbsp;&nbsp; 
                                                            ...
                                                            <td>&nbsp;&nbsp;    
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender82" runat="server" InvalidChars=".ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ~`!@#$%^&*()_=+<>,/-"
                                                                    ValidChars="1234567890" TargetControlID="ed3yr">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td align="right" width="4%" class="headings2">(%) :<span style="color: red">*</span> &nbsp;&nbsp; 
                                                            </td>
                                                            <td>&nbsp;&nbsp;        
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender73" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ~`!@#$%^&*()_=+<>,/-"
                                                                    ValidChars="1234567890." TargetControlID="ed3per">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr id="tredu4" runat="server">
                                                            <td align="right" width="10%" class="headings2">SSC :<span style="color: red">*</span> &nbsp;&nbsp; 
                                                            ...
                                                            <td>&nbsp;&nbsp;          
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender104" runat="server" InvalidChars=".1234567890 ~`!@#$%^&*()_=+<>,/-"
                                                                    ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz" TargetControlID="edu4">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td align="right" width="13%" class="headings2">Board/University :  
                                                            ...
                                                            <td>&nbsp;&nbsp; 
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender105" runat="server" InvalidChars=".1234567890~`!@#$%^&*()_=+<>,/-"
                                                                    ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz " TargetControlID="ed4brd">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td align="right" width="11%" class="headings2">Major in :
                                                                            <span style="color: red">*</span>&nbsp;&nbsp;
                                                            ...
                                                            <td>&nbsp;&nbsp;            
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender106" runat="server" InvalidChars=".1234567890~`!@#$%^&*()_=+<>/-"
                                                                    ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ," TargetControlID="ed4sub">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td align="right" width="12%" class="headings2">Year Of&nbsp; Pass :<span style="color: red">*</span>&nbsp;&nbsp;
                                                            ...
                                                            <td>&nbsp;&nbsp;     
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender81" runat="server" InvalidChars=".ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ~`!@#$%^&*()_=+<>,/-"
                                                                    ValidChars="1234567890" TargetControlID="ed4yr">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td align="right" width="4%" class="headings2">(%) : <span style="color: red">*</span>&nbsp;&nbsp;
                                                            ...
                                                            <td>&nbsp;&nbsp;      
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender74" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ~`!@#$%^&*()_=+<>,/-"
                                                                    ValidChars="1234567890." TargetControlID="ed4per">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr id="tredu5" runat="server">
                                                            <td align="right" width="10%" class="headings2">Other : &nbsp;&nbsp;</td>
                                                            <td>&nbsp;&nbsp;   
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender107" runat="server" InvalidChars=".1234567890 ~`!@#$%^&*()_=+<>,/-"
                                                                    ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz" TargetControlID="edu5">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td align="right" width="13%" class="headings2">Board/University :&nbsp;&nbsp;
                                                            </td>
                                                            ...
                                                            <td>&nbsp;&nbsp;    
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender108" runat="server" InvalidChars=".1234567890~`!@#$%^&*()_=+<>,/-"
                                                                    ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz " TargetControlID="ed5brd">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td align="right" width="12%" class="headings2">Major in :&nbsp;&nbsp;</td>
                                                            ...
                                                            <td>&nbsp;&nbsp;  
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender109" runat="server" InvalidChars=".1234567890~`!@#$%^&*()_=+<>/-"
                                                                    ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ," TargetControlID="ed5sub">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td align="right" width="11%" class="headings2">Year Of&nbsp; Pass : &nbsp;&nbsp;</td>
                                                            ...
                                                            <td>&nbsp;&nbsp;    
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender80" runat="server" InvalidChars=".ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ~`!@#$%^&*()_=+<>,/-"
                                                                    ValidChars="1234567890" TargetControlID="ed5yr">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            ...
                                                            <td>&nbsp;&nbsp;     
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender75" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ~`!@#$%^&*()_=+<>,/-"
                                                                    ValidChars="1234567890." TargetControlID="ed5per">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr id="tredu6" runat="server">
                                                            <td align="right" width="10%" class="headings2">Other1 : &nbsp;&nbsp;</td>
                                                            <td>&nbsp;&nbsp;  
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender110" runat="server" InvalidChars=".1234567890 ~`!@#$%^&*()_=+<>,/-"
                                                                    ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz" TargetControlID="edu6">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td class="headings2" width="13%" align="right">Board/University:&nbsp;&nbsp;
                                                            ...
                                                            <td>&nbsp;&nbsp;  
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender111" runat="server" InvalidChars=".1234567890~`!@#$%^&*()_=+<>,/-"
                                                                    ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz " TargetControlID="ed6brd">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td class="headings2" width="11%" align="right">Major in : &nbsp;&nbsp;
                                                            ...
                                                            <td class="headings2" width="12%" align="right">Year Of&nbsp; Pass :&nbsp;&nbsp;
                                                            </td>
                                                            ...
                                                            <td>&nbsp;&nbsp; 
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender79" runat="server" InvalidChars=".ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ~`!@#$%^&*()_=+<>,/-"
                                                                    ValidChars="1234567890" TargetControlID="ed6yr">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td class="headings2" width="4%" align="right">(%) : &nbsp;&nbsp;</td>
                                                            ...
                                                            <td>&nbsp;&nbsp;  
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender76" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ~`!@#$%^&*()_=+<>,/-"
                                                                    ValidChars="1234567890." TargetControlID="ed6per">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr id="tredu7" runat="server">
                                                            ...
                                                            <td>&nbsp;&nbsp;     
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender115" runat="server" InvalidChars=".1234567890~`!@#$%^&*()_=+<>,/-"
                                                                    ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz " TargetControlID="edu7">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td class="headings2" width="13%" align="right">Board/University : &nbsp;&nbsp;</td>
                                                            ...
                                                            <td>&nbsp;&nbsp;   
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender114" runat="server" InvalidChars=".1234567890~`!@#$%^&*()_,=+<>/-"
                                                                    ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz " TargetControlID="ed7brd">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td class="headings2" width="11%" align="right">Major in : &nbsp;&nbsp;</td>
                                                            ...
                                                            <td class="headings2" width="12%" align="right">Year Of&nbsp; Pass : &nbsp;&nbsp;</td>
                                                            ...
                                                            <td>&nbsp;&nbsp;   
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender78" runat="server" InvalidChars=".ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ~`!@#$%^&*()_=+<>,/-"
                                                                    ValidChars="1234567890" TargetControlID="ed7yr">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                            <td class="headings2" width="4%" align="right">(%) : &nbsp;&nbsp;</td>
                                                            ...
                                                            <td>&nbsp;&nbsp;  
                                                                ...
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender77" runat="server" InvalidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz ~`!@#$%^&*()_=+<>,/-"
                                                                    ValidChars="1234567890." TargetControlID="ed7per">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                        </tr>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                ...
                                                <td colspan="9">
                                                    <asp:TextBox ID="txtcomm" runat="server" TextMode="MultiLine" Height="100px" Width="80%"></asp:TextBox>
                                                </td>
                                            </tr>
                                             <tr>
                                                <td heigh="10px">&nbsp;</td>
                                            ...
                                            <tr>
                                                <td colspan="10" align="center" width="100%">
                                                    <table align="center" width="80%">
                                                        <tr>
                                                            <td align="right" class="headings2">Latest Image Upload :     
                                                            </td>
                                                ...
                                                <td colspan="10" align="center" width="100%">
                                                    <table align="center" width="40%">
                                                        <tr>
                                                            ...
                                                            <td align="right" class="headings2">Documents Upload :     
                                                            </td>
                                                            <td>
                                            ...
                                            <tr>
                                                <td colspan="10" align="center">
                                                    <asp:Button ID="Button1" runat="server" Text="Save" Width="70px" Height="30px" OnClick="Button1_Click" CssClass="btn btn-success" />

                                                    <asp:Button ID="btnsubmit" runat="server" Text="Submit" Width="70px" Height="30px" OnClick="btnsubmit_Click" CssClass="btn btn-success" ValidationGroup="emp" />
                                                    <asp:Button ID="btncancel" runat="server" Text="Cancel" Width="70px" Height="30px" OnClick="btncancel_Click" CssClass="btn btn-danger" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
