<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="User-Edit.aspx.cs" Inherits="admin_User_View" %>
                ...
                <table width="100%" border="0" >
                    <tr>
                        <td colspan="8" align="center">
                            <font size="5" color="#0e4860"><strong>Edit User Details</strong></font>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="left" colspan="1">
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <asp:TextBox ID="txtUserId" runat="server"  Width="90%" ReadOnly="true" Enabled="false"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td width="5%" align="center">:</td>
                        <td align="left" width="15%">
                            <asp:TextBox ID="txtPwd" runat="server"  Width="90%"></asp:TextBox>
                        ...
                        <td width="5%" align="center">:</td>
                        <td align="left" width="15%">
                            <asp:TextBox ID="txtconPwd" runat="server"  Width="90%"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td width="5%" align="center">:</td>
                        <td align="left" width="15%">
                            <asp:TextBox ID="txtConNumber" runat="server" onkeypress="return isNumberKey(event)" MaxLength="10" Width="90%"></asp:TextBox>
                        </td>
                        <td align="left" width="15%">
                                        ...
                                        <table id="Table1" border="0">
                                            <tr>
                                                ...
                                                <td class="style4" style="width: 100px">
                                                    <asp:RadioButton ID="rdempyes" runat="server" GroupName="employeelist" Text="Yes" AutoPostBack="true" OnCheckedChanged="rdempyes_CheckedChanged" />
                                    ...
                                    <td width="18%" valign="top">
                                        <table id="Table2" border="0">
                                            <tr>
                                                ...
                                                <td class="style4" style="width: 100px">
                                                    <asp:RadioButton ID="rdh1byes" runat="server" GroupName="rdh1b" Text="Yes" AutoPostBack="True"  OnCheckedChanged="rdh1byes_CheckedChanged"/>
                                    ...
                                    <td width="18%" valign="top">
                                        <table id="Table21" border="0">
                                            <tr>
                                                ...
                                                <td class="style4" style="width: 100px">
                                                    <asp:RadioButton ID="Profileyes" runat="server" GroupName="Profile" Text="Yes"  AutoPostBack="True"  OnCheckedChanged="Profileyes_CheckedChanged"/>
                                    ...
                                    <td width="18%" valign="top">
                                        <table id="Table3" border="0">
                                            <tr>
                                                ...
                                                <td class="style4" style="width: 100px">
                                                    <asp:RadioButton ID="Careersyes" runat="server" GroupName="Careers" Text="Yes" AutoPostBack="True"  OnCheckedChanged="Careersyes_CheckedChanged"/>
                                    ...
                                    <td width="18%" valign="top">
                                        <table id="Table6" border="0">
                                            <tr>
                                                ...
                                                <td class="style4" style="width: 100px">
                                                    <asp:RadioButton ID="Seminarsyes" runat="server" GroupName="Seminars" Text="Yes" AutoPostBack="True"  OnCheckedChanged="Seminarsyes_CheckedChanged"/>
                                    ...
                                    <td width="18%" valign="top">
                                        <table id="Table7" border="0">
                                            <tr>
                                                ...
                                                <td class="style4" style="width: 100px">
                                                    <asp:RadioButton ID="Feedbackyes" runat="server" GroupName="Feedback" Text="Yes"   AutoPostBack="True" OnCheckedChanged="Feedbackyes_CheckedChanged"/>
                    ...
                    <tr>
                        <td colspan="8" style="height: 50px" align="center">
                            <asp:Button ID="btnCreate" runat="server" Text="Update" Width="120px" Font-Bold="true" 
