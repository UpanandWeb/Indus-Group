<%@ Page Title="Admin-UserEdit" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="Admin-UserEdit.aspx.cs" Inherits="admin_Admin_UserEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      <div class="cent_content" style="margin-top:-40px;" >
       ...
       <%-- <span style="margin-right:-1059px">
              <asp:Button ID="Button1" runat="server" Text="Add User" BackColor="#0b2e82" ForeColor="White" Width="100px" Font-Size="20px" Height="38px" />
        </span>--%>
        <br />
        <br />
    ...
    <tr id="tr2" runat="server">
                     ...
                     <td width="40px" align="center" valign="top">
                      ...
                      <asp:DropDownList ID="ddldesig" runat="server" Width="230px" Font-Size="24px">
                     <asp:ListItem Value="0">Select</asp:ListItem>
                    <asp:ListItem Value="1">Admin</asp:ListItem>
                           <asp:ListItem Value="2">Accounts</asp:ListItem>
                    <asp:ListItem Value="3">Web Admin</asp:ListItem>
                    <asp:ListItem Value="4">Developer</asp:ListItem>
                      </asp:DropDownList>
                      <asp:RequiredFieldValidator ID="requireddesignation" runat="server" ControlToValidate="ddldesig" ErrorMessage="Please Enter Your designation" ValidationGroup="userform" ForeColor="Red" InitialValue="0">*</asp:RequiredFieldValidator>
                      ...
                      <td align="left" width="210px" valign="top" >
                      <asp:TextBox ID="txtpassword" runat="server" Font-Size="20px" ></asp:TextBox>
                      <asp:RequiredFieldValidator ID="requiredpwd" runat="server" ControlToValidate="txtpassword" ErrorMessage="Please Enter  Password" ValidationGroup="userform" ForeColor="Red">*</asp:RequiredFieldValidator>
                         ...
                         <td align="left" width="210px" valign="top">
                         <asp:TextBox ID="txtcnfpwd" runat="server" Font-Size="20px" ></asp:TextBox>
