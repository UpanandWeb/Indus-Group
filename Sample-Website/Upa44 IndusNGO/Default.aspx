                                        ...
                                        <div class="row">
                                            <div class="col-lg-2">
                                                <a href="#" class="thumbnail">
                                                    <img src="images/slogofinal_1.jpg" alt="Image" style="height: 80px;"></a>
                                            </div>
                                            <div class="col-lg-2">
                                                <a href="#" class="thumbnail">
                                                    <img src="images/slogofinal_2.jpg" alt="Image" style="height: 80px;"></a>
                                            </div>
                                            <div class="col-lg-2">
                                                <a href="#" class="thumbnail">
                                                    <img src="images/slogofinal_3.jpg" alt="Image" style="height: 80px;"></a>
                                            </div>
                                            <div class="col-lg-2">
                                                <a href="#" class="thumbnail">
                                                    <img src="images/slogofinal_4.jpg" alt="Image" style="height: 80px;"></a>
                                            </div>
                                            <div class="col-lg-2">
                                                <a href="#" class="thumbnail">
                                                    <img src="images/slogofinal_5.jpg" alt="Image" style="height: 80px;"></a>
                                            </div>
                                            <div class="col-lg-2">
                                                <a href="#" class="thumbnail">
                                                    <img src="images/slogofinal_6.jpg" alt="Image" style="height: 80px;"></a>
                                            </div>
                                        </div>
                                        <!--.row-->
                                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="rite_updates">
                            ...
                            <div class="updates_window">
                                <div>
                                    <asp:DataList ID="DataList2" Width="100%" runat="server" RepeatColumns="1" OnItemCommand="DataList2_ItemCommand">
                                        <ItemTemplate>
                                            <table width="100%" style="border-bottom: 1px solid #ddd; display: block; margin-bottom: 20px; overflow: hidden; padding-bottom: 20px;">
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="latest-news-right">
                                                            ...
                                                            <div class="news">
                                                                <span class="news-left">Admin</span> <span class="news-right">
                                                                    <asp:Label ID="Label2" runat="server" Text='<%# Eval("posteddate") %>'></asp:Label></span>
                                                            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        ...
                        <asp:DataList ID="dlsup" runat="server" Width="100%" RepeatColumns="3">
                            <ItemTemplate>
                                <div class="col-lg-12">
                                    <div class="support_block">

                                        <h1>
                                            <asp:Label ID="lbsup" runat="server" Text='<%# Eval("title") %>'></asp:Label></h1>
                                   
                                                     <asp:ImageButton ID="supimg" runat="server" Width="100%" Height="467" AlternateText="No Image" ImageUrl='<%# Eval("imagename", "photos/support/{0}") %>' BorderStyle="Solid" BorderWidth="2px" BorderColor="black" CssClass="imgst"   />
