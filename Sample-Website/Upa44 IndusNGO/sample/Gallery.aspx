                        ...
                        <div class="row">                         	                     	                       	
                            ...
                            <div class="col-lg-2 nopadding">
                            	<div class="phone_outer">
                                  <span><img src="images/phone.png" width="25" height="25" alt=""/>IND :</span><a href="tel:6303850877" target="_blank">+91-6303850877</a>
                                </div>                            	
                            </div>
                            <div class="col-lg-2 nopadding">
                            	<div class="mail_outer">
                                  <!--<span><img src="images/mail.png" width="25" height="25" alt=""/></span>--><a href="mailto:info@anandamfoundation.com" target="_blank">info@anandamfoundation.com</a>
                                </div>
                            </div>
                            <div class="col-lg-2">
                            	<div class="phone_outer">
                                  <span><img src="images/phone.png" width="25" height="25" alt=""/>USA :</span><a href="tel:703-593-1234" target="_blank">703-593-1234</a>
                                </div>		
                            </div>
                           <div class="col-lg-2">
        ...
        <div class="row">
            <div class="col-lg-12 nopadding">
              <div class="donate_bgouter">
   	  	  	  	<img src="images/gallery_bg.jpg" width="1200" height="300" alt=""/> 
              </div>  
            </div>
        </div>      
      </div>
                	...
                	<div class="row">
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="photo_gallery"> 
                                    <asp:LinkButton ID="lnk1" runat="server" Text="Home" PostBackUrl="Default.aspx" Font-Size="22px"></asp:LinkButton> >> <asp:Label ID="lbhome"  Text="Gallery" runat="server" ForeColor="#ff9933" Font-Size="22px"></asp:Label>                         	
                                 <div class="row">
                                     
                                          <div class="col-lg-2" id="div1" runat="server">
                                            <asp:DataList ID="ddlgallery" runat="server" RepeatColumns="6" OnItemCommand="ddlgallery_ItemCommand">
                                                ...
                                                <ItemTemplate>
                                                            ...
                                                            <div class="thumb_container">
                                                                <table>
                                                                    <tr>
                                                                        <td>
                                                                              <asp:ImageButton ID="img" runat="server"  ImageUrl='<%# Eval("imagename", "photos/gallery/{0}") %>' width="235" height="230" alt=""  CssClass="img-fluid" CommandName="view" CommandArgument='<%# Eval("id") %>' /> <br />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="center">
                                                                              <asp:LinkButton ID="lb" runat="server" Text='<%# Eval("title") %>' Font-Size="18px"></asp:LinkButton>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                              ...
                                              <%--         <a href='<%# Eval("imagename", "photos/gallery/{0}") %>' class="fancybox" rel="ligthbox">--%>
                                                      ...
                                                      <div id="dv" runat="server" class="col-lg-2" >
                                                            ...
                                                            <div class="thumb_container">
                                                                <table>
                                                                    <tr>
                                                                        <td>
                                                                                <a href='<%# Eval("imagename", "photos/gallery/{0}") %>' class="fancybox" rel="ligthbox">
                                                                              <asp:ImageButton ID="img" runat="server"  ImageUrl='<%# Eval("imagename", "photos/gallery/{0}") %>' width="235" height="230" alt=""  CssClass="img-fluid" /> <br />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="center">
...
<%--                                                                              <asp:Label ID="lb" runat="server" Text='<%# Eval("title") %>'></asp:Label>--%>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                    	...
                    	<div class="row"> 
                            ...
                            <div class="col-lg-3">
                            	<div class="contactano_outer">                                	
                                    <p><strong>Anandam Foundation</strong> <br> Plot # 21,Flat #203,Techno Residency,<br>Opp: Mind Space(Raheja IT Park),<br>Madhapur, Hyderabad, TS-500081,INDIA.</p>                                    
                                </div>
                            </div>
                            <div class="col-lg-3">
