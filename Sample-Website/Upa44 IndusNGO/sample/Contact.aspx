        	...
        	<div class="col-lg-12">
            	<div class="contactpage_outer">
                   <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12 nopadding">
                                     <asp:LinkButton ID="lnk1" runat="server" Text="Home" PostBackUrl="Default.aspx" Font-Size="22px"></asp:LinkButton> >> <asp:Label ID="lbhome"  Text="Contact" runat="server" ForeColor="#ff9933" Font-Size="22px"></asp:Label>    
                                    ...
                                    <div class="row"> 
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <form method="post" autocomplete="off">
                                                        ...
                                                        <asp:TextBox ID="txt" runat="server" placeholder="Name" Width="600px" ></asp:TextBox>
                                                     ...
                                                     <%--   <input type="text" placeholder="Name" required /--%>
                                                         ...
                                                         <asp:TextBox ID="txt2" runat="server" placeholder="Email" Width="600px"></asp:TextBox>
                                                ...
                                                <div class="row">
                                                     <div class="col-lg-12">
                                                       <asp:TextBox ID="TextBox1" runat="server" placeholder="Phone*" Width="600px"></asp:TextBox>
                                                ...
                                                <div class="row">                        
                                                    <div class="col-lg-12">
                                                       <asp:TextBox ID="TextBox2" runat="server" placeholder="Location" Width="600px"></asp:TextBox>
