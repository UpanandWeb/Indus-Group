...
<body>
    ...
    <div>
    <div id="admintot_outer" style="background-color:#abc8e4;">
                                         ...
                                         <div class="row nopadding">
                                             <div class="col-lg-12 m-auto">
                                                <div class="topentry_outer">
                                                    <img src="images/sorophyd_logo.png"  alt="" /> 
       ...
       <%--                                            <asp:TextBox ID="txt" runat="server" placeholder="User type*"></asp:TextBox>--%>
                                                   ...
                                                   <asp:RequiredFieldValidator ID="req" runat="server" ControlToValidate="txt" InitialValue="0" ValidationGroup="vl" ErrorMessage="Select User type" ForeColor="Red">*</asp:RequiredFieldValidator>
                                                                <asp:TextBox ID="txt1" runat="server" placeholder="User Name*"></asp:TextBox>
                                                   <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txt1" ValidationGroup="vl" ErrorMessage="Enter Username" ForeColor="Red">*</asp:RequiredFieldValidator>
