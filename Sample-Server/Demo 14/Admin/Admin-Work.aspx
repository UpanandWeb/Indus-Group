<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="Admin-Work.aspx.cs" Inherits="Admin_Admin_Work" %>
                                ...
                                <tr>
                                    <td align="center" width="100%" colspan="7">
                                        <asp:GridView ID="newsgrid" runat="server" Width="86%" AutoGenerateColumns="False" BorderColor="#CCCCCC" BorderWidth="3px"
                                            ...
                                            DataKeyNames="pid" Font-Overline="False" Font-Size="11pt" Font-Strikeout="False" Font-Underline="False" BackColor="White"
                                          ...
                                          <asp:TemplateField ItemStyle-BorderColor="#CCCCCC" HeaderText="ID" HeaderStyle-Width="10%" ItemStyle-Width="5%">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblempidsss" ForeColor="Gray" Text='<%# Bind("pid") %>' runat="server"></asp:Label>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField ItemStyle-BorderColor="#CCCCCC" HeaderText="Title" HeaderStyle-Width="10%" ItemStyle-Width="5%">
                                                    ...
                                                    <asp:TemplateField ItemStyle-BorderColor="#CCCCCC" HeaderText="Discription" HeaderStyle-Width="20%" ItemStyle-Width="4%">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblout1" ForeColor="Gray" Text='<%# Bind("Discription") %>' runat="server" CssClass="data"></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:TemplateField>
