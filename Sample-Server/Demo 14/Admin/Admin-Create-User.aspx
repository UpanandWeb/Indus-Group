<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="Admin-Create-User.aspx.cs" Inherits="Admin_Admin_Create_User" %>
                                                                        ...
                                                                        <table id="Table13" border="0">
                                                                            <tr>
                                                                                ...
                                                                                <td class="style4" style="width: 140px">
                                                                                    <asp:RadioButton ID="Clientyes" runat="server" GroupName="Client" Text="Yes" AutoPostBack="True" Font-Size="13px" Checked="true" OnCheckedChanged="Clientyes_CheckedChanged" />
                                                                    ...
                                                                    <td class="datab" width="30%" valign="top">
                                                                        <table id="Table14" border="0">
                                                                            <tr>
                                                                                ...
                                                                                <td class="style4" style="width: 140px">
                                                                                    <asp:RadioButton ID="Vendoryes" runat="server" GroupName="Vendor" Text="Yes" AutoPostBack="True" Font-Size="13px" Checked="true"  OnCheckedChanged="Vendoryes_CheckedChanged" />
                                                                    ...
                                                                    <td class="datab" width="30%" valign="top">
                                                                        <table id="Table18" border="0">
                                                                            <tr>
                                                                                ...
                                                                                <td class="style4" style="width: 140px">
                                                                                    <asp:RadioButton ID="Usersyes" runat="server" GroupName="Users" Text="Yes" AutoPostBack="True" Font-Size="13px" Checked="true" OnCheckedChanged="Usersyes_CheckedChanged" />
                                ...
                                <tr>
                                    <td colspan="6" style="height: 50px" align="center">
                                        <asp:Button ID="btnCreate" runat="server" Text="Create User" OnClick="btnCreate_Click"
                                             ValidationGroup="UserIdCreation" Font-Size="18px" Width="120px" Height="25px" />

                                        <asp:Button ID="Button1" runat="server" Text="Cancel " Font-Size="18px" Width="80px" Height="25px" OnClick="Button1_Click"
                                             />
                                    </td>
                                </tr>
                                <tr>
