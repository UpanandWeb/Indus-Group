<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_Countries_Edit.aspx.cs" Inherits="Admin_Countries_Edit" %>
...
<head id="Head1" runat="server">
    <title> : : Indus Group : : - Admin Control Panel - Countries_Edit</title>
      ...
      <td id="tdcontent" runat="server" align="center" valign="top" width="100%" class="lable"> 
       ...
       <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
         ...
         <td align='center' style="width: 100%"><font color='#003399' size='3pt'><b>Edit Country Name</b></font></td> </tr>
</table> 
</td>
                                            </tr>
