<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_ClientCreate.aspx.cs" Inherits="Admin_ClientCreate" %>
<%@ Register Src="Usercontrols/Admin_TopMenu.ascx" TagName="TopMenu" TagPrefix="uc1" %>

<html xmlns="http://www.w3.org/1999/xhtml" >

<head id="Head1" runat="server">
 <title> : : Indus Group : : - Admin Control Panel - Vendor_Edit</title>
...
<tr height="19">
    ...
    <tr height="15">
      <td colspan="2" align="left" valign="top" bgcolor="#336699" class="headings style23" style="height: 13px">User id &amp; Password</td>
    </tr>
    <tr height="15">
    ...
    <tr>
      ...
      <td align="left" valign="top" width="50%" style="height: 19px" class="lable">&nbsp;&nbsp;
          <asp:TextBox ID="txtpwd" runat="server" Height="19px"
                                                Width="146px" TextMode="Password"  onblur='javascript:checkpwdlen();' ></asp:TextBox>
    ...
    <tr>
      ...
      <td align="left" valign="top" width="50%" style="height: 19px" class="lable">&nbsp;&nbsp;
          <asp:TextBox ID="txtconpwd" runat="server" Height="19px"
                                                Width="146px" TextMode="Password" onblur='javascript:checkpwd();'></asp:TextBox>
        </td>
    </tr>
    <tr height="8">
      <td align="right" valign="middle" width="20%" height="8"></td>
