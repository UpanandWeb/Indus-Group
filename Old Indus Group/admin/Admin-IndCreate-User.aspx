<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin-IndCreate-User.aspx.cs" Inherits="admin_Admin_IndCreate_User" %>
                        ...
                        <tr>
                          ...
                          <tr>
                            ...
                            <td width="20%" align="right">
                                <asp:Label ID="lblrate" runat="server" Text="Monthly Salary " Font-Size="18px"></asp:Label>
                            <span style="color: red">*</span> &nbsp;&nbsp;
                            </td>
