<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_JobPost_Create.aspx.cs" Inherits="Admin_JobPost_Create" %>
...
<title> : : Indus Group : : - Admin Control Panel - Jobpost_Create</title>
...
<body topmargin="0" bottommargin="0" leftmargin="0" id="body1" runat="server">
<form id="form1" runat="server">
<table width="995" cellpadding="0" cellspacing="0">
<tr>

<td colspan="1"> <uc1:TopMenu ID="Topmenu1" runat="server" />
    </td>
...
<tr height="19">
    ...
    <tr>
      ...
      <td style="height: 22px; width: 286px;" class="lable5">
          <asp:DropDownList ID="minsal" runat="server" CssClass="lable4" Width="110px">
    ...
    <tr>
      ...
      <td style="height: 19px; width: 286px;" class="lable5">
          <asp:DropDownList ID="maxsal" runat="server" CssClass="lable4" Width="110px">
            <asp:ListItem selected="True">Select Salary</asp:ListItem>
            <asp:ListItem value="50000">&lt;50K</asp:ListItem>
            <asp:ListItem value="100000">1</asp:ListItem>
            <asp:ListItem value="200000">2</asp:ListItem>
    ...
    <tr>
      <td style="width: 132px" class="lable6"> Contact Person</td>
