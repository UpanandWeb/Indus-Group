<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_EmpVendor_Delete.aspx.cs" Inherits="Admin_EmpVendor_Delete" %>

<%@ Register Src="Usercontrols/Admin_TopMenu.ascx" TagName="TopMenu" TagPrefix="uc1" %>

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title> : : Indus Group : : - Admin Control Panel -EmpVendor_Delete</title>
...
<body id="body1" runat="server" topmargin="0" leftmargin="0" bgcolor="#F6FDFD">
 ...
 <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
   ...
   <tr>
   <td align="center" style="height: 21px;"> &nbsp;VENDOR INFORMATION FORM </td>
   </tr>
   </table>
...
<table style="width: 100%">
        ...
        <table style="width: 100%">
            <tr>
                <td class="headings"> Accounts Manager Information </td>
            </tr>
        </table>
        <table style="width: 100%">
            <tr>
        ...
        <table style="width: 100%">
            <tr>
                <td class="headings"> Recruiter Information </td>
            </tr>
        </table>
        <table style="width: 100%">
            <tr>
