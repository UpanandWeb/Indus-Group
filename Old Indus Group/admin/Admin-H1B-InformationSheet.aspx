<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin-H1B-InformationSheet.aspx.cs" Inherits="admin_Admin_H1B_InformationSheet" %>
            ...
            <tr>
                <td height="30px" align="center">
                   <asp:RadioButton ID="h1checklist"  runat="server" Text="H-1B PETITION CHECKLIST"  GroupName="h1b" OnCheckedChanged="h1checklist_CheckedChanged" AutoPostBack="true" />
                    ...
                    <asp:RadioButton ID="h1information"  runat="server" Text="H-1B INFORMATION SHEET"  Checked="true" GroupName="h1b" OnCheckedChanged="h1information_CheckedChanged" AutoPostBack="true"/>
                </td>
            </tr>
            <tr>
                <td height="30px" align="center">
