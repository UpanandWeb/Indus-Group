<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_UserCreate.aspx.cs" Inherits="Admin_UserCreate" %>
<%@ Register Src="Usercontrols/Admin_TopMenu.ascx" TagName="TopMenu" TagPrefix="uc1" %>

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title> : : Indus Group : : - Admin Control Panel - UserCreate</title>
   ...
   <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
    ...
    <td colspan='2' align="left" valign="bottom" style="height: 30px">
      <font size='4pt' color="#660000"><b>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
          &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
          &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Create New User Details</b></font></td>
          </tr>
          <tr>
