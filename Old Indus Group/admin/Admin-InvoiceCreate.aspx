<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin-InvoiceCreate.aspx.cs" Inherits="admin_Admin_InvoiceCreate" MaintainScrollPositionOnPostback="true" %>
                                                                ...
                                                                <tr>
                                                                    <td width="80%" align="left"><span style="width: 40px;"></span>
                                                                        ...
                                                                        <asp:RequiredFieldValidator ID="Requiredfieldvalidator14" runat="server" ControlToValidate="DropDownList1" Display="Dynamic"
                                                                            ErrorMessage="Select  Date  Range" ForeColor="Red" SetFocusOnError="true">*</asp:RequiredFieldValidator>
                                                                    </td>
