...
namespace igiit.Includes
{
	...
	#region ChatEngine Class
	public class ChatEngine
	{
		public static Hashtable Rooms = new Hashtable(100); 
		public ChatEngine()
		{}
		/// <summary>
		...
		public static ChatRoom GetRoom(string user1ID,string user1Name,string user2ID,string user2Name) 
		{
			ChatRoom room=null;
