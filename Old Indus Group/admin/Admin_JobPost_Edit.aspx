<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_JobPost_Edit.aspx.cs" Inherits="igiit_Admin_Admin_JobPost_Edit" %>
...
<title> : : Indus Group : : - Admin Control Panel - Jobpost_Edit</title>
...
<td colspan="2">
    <uc1:TopMenu ID="Topmenu1" runat="server" /></td>
</tr>
...
<table width="100%" align="left">
              ...
              <tr height="190">
               ...
               <table border="0" class="border" width="100%" align="left">
    <tr height="19">
      <td colspan="2" bgcolor="#336699" class="headings style21" style="height: 14px"> Modify Job Posting Details</td>
    </tr>
    <tr>
      <td class="lable4" style="height: 19px; width: 132px;"> Job Title</td>
    ...
    <tr>
      <td style="height: 19px; width: 132px;" class="lable4"> Number of Posts</td>
    ...
    <tr>
      <td style="width: 132px; height: 19px;" class="lable4"> Key Skills</td>
      <td style="height: 19px; width: 286px;" class="lable5">
    ...
    <tr>
      <td style="width: 132px; height: 19px;" class="lable4"> Basic Qualification</td>
      <td style="height: 19px; width: 286px;" class="lable5">
    ...
    <tr>
      <td style="width: 132px" class="lable4"> Minimun Experience</td>
      <td style="height: 19px; width: 286px;" class="lable5">
    ...
    <tr>
      <td style="width: 132px" class="lable4"> Maximum Experience</td>
      <td style="height: 19px; width: 286px;" class="lable5">
    ...
    <tr>
      <td style="width: 132px; height: 23px;" class="lable4"> Functional Area</td>
    ...
    <tr>
      <td style="width: 132px; height: 22px;" class="lable4"> Minimun Salary (in Lakhs)</td>
    ...
    <tr>
      <td style="width: 132px" class="lable4"> Maximum Salary (in Lakhs)</td>
      <td style="height: 19px; width: 286px;" class="lable5">
    ...
    <tr>
      <td style="width: 132px" class="lable4"> Currency</td>
    ...
    <tr>
      <td style="width: 132px; height: 19px;" class="lable4"> Location</td>
    ...
    <tr>
      <td style="width: 132px" class="lable4"> Condact Person</td>
    ...
    <tr>
      <td style="width: 132px" class="lable4">&nbsp;Phone Number</td>
    ...
    <tr>
      <td style="width: 132px" class="lable4"> Email Address</td>
