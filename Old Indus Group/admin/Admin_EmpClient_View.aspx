<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_EmpClient_View.aspx.cs" Inherits="Admin_EmpClient_View" %>

<%@ Register Src="Usercontrols/Admin_TopMenu.ascx" TagName="TopMenu" TagPrefix="uc1" %>

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title> : : Indus Group : : - Admin Control Panel - EmpClient_View</title>
...
<body id="body1" runat="server" topmargin="0" leftmargin="0" bgcolor="#F6FDFD">
 ...
 <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
    ...
    <tr>
      ...
      <table width="100%">
<tr height="19">
               <td width="100%" align="left" class="toplft" height="15">
               <a href="Admin_ClientForm.aspx" class="data5">
               Add New Client Details</a></td>
              </tr>
              <tr height="190">
               ...
               <table width="100%" height="229" border="0">
                ...
                <tr>
                <td style="height: 24px; width: 73px;" class="lable5">
                    Name</td>
                ...
                <tr>
                <td style="height: 20px; width: 73px;" class="lable5">
                    Industry </td>
                ...
                <asp:Label ID="addr" runat="server" CssClass="lable6" Width="172px" 
                 ...
                 <tr>
                        <td style="width: 73px; height: 20px;" class="lable5">
                            Location</td>
                        <td style="height: 20px" class="lable6">
                ...
                <asp:Label ID="Label6" runat="server" CssClass="lable6" Width="172px" 
                 ...
                 <tr>
                   <td style="width: 73px" class="lable5">
                       &nbsp;</td>
                   <td>
                       &nbsp;</td>
                  </tr>
...
<tr>
<td class="headings">Previous Clients Details</td>
</tr>
...
<asp:GridView ID="GridCysto" runat="server" AllowPaging="True" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="false" CssClass="headings">
            ...
            <asp:BoundField HeaderText="Supervisor Name" DataField="suname" />
