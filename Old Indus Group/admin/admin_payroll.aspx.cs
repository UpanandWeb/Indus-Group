...
public partial class invoice_Default2 : System.Web.UI.Page
{
    exception es = new exception();
    string page = "admin_payroll.aspx";
    Double tEmpRate;
    Double tIGIRate;   
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            lb1.Visible = true;
            lb.Visible = true;
            lbactutot.Visible = true;
            lblottot.Visible = true;
            GridView1.Visible = true;
            double ac = 0;
            double ot = 0;
            // UpdatePanel3.Update();
            DataTable dt = new DataTable();
            dt.Columns.Add("week");
            dt.Columns.Add("reghours");

            dt.Columns.Add("actualrate");
            dt.Columns.Add("totalregamount");
            dt.Columns.Add("othours");
            dt.Columns.Add("otrate");
            dt.Columns.Add("totalotamount");
            ...
            for (int row = 0; row < GridView1.Rows.Count; row++)
            {
                ...
                dr[6] = GridView1.Rows[row].Cells[6].Text;
                ...
                if (GridView1.Rows[row].Cells[2].Text != "&nbsp;")
                {
                    dr[2] = GridView1.Rows[row].Cells[2].Text.Trim();
                }
                else
                {
                    dr[2] = GridView1.Rows[row].Cells[1].Text = "";
                }
                if (GridView1.Rows[row].Cells[3].Text != "&nbsp;")
                {
                    dr[3] = GridView1.Rows[row].Cells[3].Text.Trim();
                }
                else
                {
                    dr[3] = GridView1.Rows[row].Cells[3].Text = "";
                }
                if (GridView1.Rows[row].Cells[4].Text != "&nbsp;")
                {
                    dr[4] = GridView1.Rows[row].Cells[4].Text.Trim();
                }
                else
                {
                    dr[4] = GridView1.Rows[row].Cells[4].Text = "";
                ...
                if (GridView1.Rows[row].Cells[5].Text != "&nbsp;")
                {
                    dr[5] = GridView1.Rows[row].Cells[5].Text.Trim();
                }
                else
                {
                    dr[5] = GridView1.Rows[row].Cells[5].Text = "";
                }
                if (GridView1.Rows[row].Cells[6].Text != "&nbsp;")
                {
                    dr[6] = GridView1.Rows[row].Cells[6].Text.Trim();
                }
                else
                {
                    dr[6] = GridView1.Rows[row].Cells[6].Text = "";
            ...
            string range = ddlWeekRanges.SelectedItem.Text;
            ...
            //  SqlDataAdapter ad = new SqlDataAdapter("select hourrate,otrate, case when startdate is null then enddate when enddate is null then startdate else null end as startdate from vendors where emp_id='" + empid1 + "' and startdate between  '" + finalweek + "' and '" + finalweek2 + "'", con);


            SqlDataAdapter ad = new SqlDataAdapter("select   distinct top 1 hourrate,otrate,startdate from vendors where emp_id='" + empid1 + "' and  startdate <= convert (datetime,'" + finalweek + "') order by startdate desc", con);
            DataSet ds = new DataSet();
            ...
            {
                string ot1 = "";
                ac = Convert.ToDouble(ds.Tables[0].Rows[0]["hourrate"].ToString());
                ot1 = ds.Tables[0].Rows[0]["otrate"].ToString();
                if (ot1 == "")
                {
                    ot = 0.0;
                }
                ...
                {
                    ot = Convert.ToDouble(ds.Tables[0].Rows[0]["otrate"].ToString());
                }
            ...
            {
                SqlDataAdapter ad1 = new SqlDataAdapter("select * from  [EmpContacts] where emp_id='" + empid1 + "'", con);
                DataSet ds1 = new DataSet();
                ad1.Fill(ds1);
                if (ds1.Tables[0].Rows.Count > 0)
                {
                    string name = ds1.Tables[0].Rows[0]["cname"].ToString();
                    string email = ds1.Tables[0].Rows[0]["cemail"].ToString();
                    //ViewState["em"] = email;
                    //ViewState["em"] = empid1;
                    ...
                    SqlDataAdapter ad12 = new SqlDataAdapter("select hrate,ot from ig_invoice where cemail='" + email + "'", con);
                    DataSet ds12 = new DataSet();
                    ad12.Fill(ds12);
                    if (ds1.Tables[0].Rows.Count > 0)
                    {
                        ac = Convert.ToDouble(ds12.Tables[0].Rows[0]["hrate"].ToString());

                        ot = Convert.ToDouble(ds12.Tables[0].Rows[0]["ot"].ToString());
                    }
                    else
                    {
            ...
            if (ddlHrType.SelectedItem.Text == "Regular")
            {
                double reg = Convert.ToDouble(ac);
                double hour = Convert.ToDouble(txtNoOfHours.Text);
                double tot = Convert.ToDouble(hour * reg);
                dt.Rows.Add(ddlWeekRanges.SelectedItem.Text, txtNoOfHours.Text, reg, tot, 0, 0, 0);
            }
            else if (ddlHrType.SelectedItem.Text == "OT")
            {
                double reg = Convert.ToDouble(ot);
                double reg1 = Convert.ToDouble(ac);
                double tot = 0;
                double hour = 0;
                if (reg == 0.00 || reg == 0 || reg == null)
                {
                    reg = Convert.ToDouble(ac);
                    hour = Convert.ToDouble(txtNoOfHours.Text);
                    tot = Convert.ToDouble(hour * reg);
                    // dt.Rows.Add(ddlWeekRanges.SelectedItem.Text, 0, 0, 0, txtNoOfHours.Text, reg, tot);
                    dt.Rows.Add(ddlWeekRanges.SelectedItem.Text, 0, reg1, 0, txtNoOfHours.Text, reg, tot);
                }
            ...
            foreach (ListItem li in ddlWeekRanges.Items)
            {
                if (li.Selected)
            ...
            bindmaingrid();
            calculateminus();
            // int val= (txtActualRate.Text) * (txtPayPeriod.Text);
        }
        catch (Exception ex)
        {
            es.insert_exception(ex, page);
        ...
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    SqlDataAdapter ad1 = new SqlDataAdapter("select  * from emp_weekdetails where mpid='" + id + "'", con);
                    ...
                    for (int i1 = 0; i1 < dt1.Rows.Count; i1++)
                    {
                        ...
                        row1["Week From"] = dt1.Rows[i1]["week_rangefrom"].ToString();
                        row1["Week To"] = dt1.Rows[i1]["week_rangeto"].ToString();
                        row1["Reg. Hours"] = dt1.Rows[i1]["Hours"].ToString();
                        row1["Ot Hours"] = dt1.Rows[i1]["hour_type"].ToString();
                        row1["Actual Rate"] = dt1.Rows[i1]["actual_rate"].ToString();
                        row1["OT Rate"] = dt1.Rows[i1]["ot_rate"].ToString();

                        IEnumerable<DataRow> newRows = dt1.AsEnumerable().Skip(1);
                        DataTable dt2 = newRows.CopyToDataTable();

                        d2.Rows.Add("Date :", dt1.Rows[i1]["week_rangefrom"].ToString(), dt1.Rows[i1]["week_rangeto"].ToString(), dt1.Rows[i1]["Hours"].ToString(), dt1.Rows[i1]["hour_type"].ToString(), dt1.Rows[i1]["actual_rate"].ToString(), dt1.Rows[i1]["ot_rate"].ToString());
                        // d2.ImportRow(dr1);
                    }
                }
 ...
 protected void ddlMonth_SelectedIndexChanged(object sender, EventArgs e)
    ...
    protected void btn_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            foreach (GridViewRow g1 in GridView1.Rows)
            {
                ...
                string yer = ddlYear.SelectedItem.Text;
                SqlCommand cmd = new SqlCommand("insert into emp_weekdetails(empid ,hours,hour_type,week_rangefrom,week_rangeto,month_year,actual_rate,ot_rate,mpid,createddate ) values ('" + empid + "', '" + g1.Cells[1].Text + "','" + g1.Cells[4].Text + "','" + week1 + "','" + week2 + "','"+empid+"-" + str1 + "-" + yer + "','" + ac + "','" + ot + "'," + id + ",'" + date + "')", con);
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
               ...
               // ViewState["ot"] = txtOTRate.Text;
                ...
                else
                {
                    ...
                    {
                        if (Convert.ToString(ds12.Tables[0].Rows[0]["totgross"]) == "" || Convert.ToString(ds12.Tables[0].Rows[0]["totgross"]) == null)
                        {
                            double ytd = Convert.ToDouble(ds12.Tables[0].Rows[0]["CurrentYTD"].ToString());
                            TextBox6.Text = (ytd).ToString();
                        }
                        else
                        {
                            double ytd = Convert.ToDouble(ds12.Tables[0].Rows[0]["CurrentYTD"].ToString());
                        ...
                        txtLCASalary.Text = Convert.ToString(ds12.Tables[0].Rows[0]["lcasal"].ToString());
                    }
                }
                //grid.Visible = false;
            }
    ...
    protected void OnRowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            if ((e.Row.RowState == DataControlRowState.Normal) || (e.Row.RowState == DataControlRowState.Alternate))
            {
                string employeeId = gvEmployeePay.DataKeys[e.Row.RowIndex].Value.ToString();
                ViewState["empid"] = employeeId;
                SqlDataAdapter ad0 = new SqlDataAdapter("select * from monthpay where mpid='" + employeeId + "' order by mpid desc", con);
    ...
    protected void gvEmployeePay_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "delete")
        {
            ...
            SqlCommand cmd1 = new SqlCommand("delete from emp_weekdetails where mpid='" + id + "' ", con);
            SqlCommand cmd = new SqlCommand("delete from monthpay where mpId='" + id + "'", con);
    ...
    protected void Update1(object sender, EventArgs e)
    {
       ...
       // TextBox minus = (TextBox)row.FindControl("txtminus");
        ...
        {
            SqlDataAdapter ad = new SqlDataAdapter("select * from monthpay where mpid='" + user + "' ", con);
        ...
        SqlCommand cmd1 = new SqlCommand("update monthpay set remark='"+remark.Text+"', DespofDeduct='"+insudesp.Text+"' ,Rate_Insurance='"+insu.Text+"', advaPay='" + payadva.Text + "', mont='" + month.Text + "', EmpRate='" + emprate.Text + "',pDium='" + peri.Text + "',bepay='" + balance.Text + "',totgross='" + totalgross.Text + "',minuspercent='" + minus.SelectedValue + "',igigross='" + igigross.Text + "',empgross='" + empgross.Text + "',salary='" + salary.Text + "',bonus='" + bonus.Text + "',visatype='" + visatype.SelectedValue + "',Lcasal='" + lcbalance.Text + "',CurrentYTD='" + ytd.Text + "',EmpId='" + emp.Text + "',colorcode='" + color.SelectedValue + "' where mpid='" + user + "'", con);
        //SqlCommand cmd = new SqlCommand("update monthpay set ")
        cmd.ExecuteNonQuery();
        cmd1.ExecuteNonQuery();
        con.Close();
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            foreach (GridViewRow g1 in GridView1.Rows)
            {
                ...
                string yer = ddlYear.SelectedItem.Text;
                string date = DateTime.Now.ToString();
                SqlCommand cmd2 = new SqlCommand("insert into emp_weekdetails(empid ,hours,hour_type,week_rangefrom,week_rangeto,month_year,actual_rate,ot_rate,mpid,createddate ) values ('" + empid + "', '" + g1.Cells[1].Text + "','" + g1.Cells[4].Text + "','" + week1 + "','" + week2 + "','" + str1 + "-" + yer + "','" + ac + "','" + ot + "'," + id + ",'" + date + "')", con);
    ...
    protected void txtDEDBPayNewRate_TextChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                {
                    insu = Convert.ToDouble(txtDEDBPayNewRate.Text);
                }
