<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_payrolla1.aspx.cs" EnableViewStateMac="false" Inherits="invoice_Default2" MaintainScrollPositionOnPostback="true" %>
...
<body topmargin="0" leftmargin="0" bgcolor="#F6FDFD">
    ...
    <tr width="998px">
     ...
     <tr> <td align='center' bgcolor='white' width='70%'><font color='#003399' size='6pt'><b><u>Payroll Automatic Data</u></b></font> </td>
        </tr>
       </table>
      </td>
    </tr>
        ...
        <div id="wkdetails" runat="server">
            ...
            <div id="divgrid1" runat="server" style="width:100%;">
               ...
               <asp:BoundField HeaderStyle-Width="120px" HeaderText="OT Hours" DataField="othours" HeaderStyle-HorizontalAlign="Center" ItemStyle-Font-Size="14px" ItemStyle-HorizontalAlign="Center" />
                ...
                <EditItemTemplate>    
                    <asp:LinkButton ID="LinkButton5" Text="Update" runat="server" OnClick="OnUpdate" ForeColor="Black" />    
                   ...
                   <%-- <EditRowStyle  ForeColor="White" Font-Size="14px" />--%>
           ...
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
           Total :   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <span id="lb" runat="server"> Regular Hours :</span> 
                   <asp:Label ID="lbactutot" runat="server" ></asp:Label>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
             &nbsp; &nbsp;&nbsp;&nbsp;    <span id="Span1" runat="server"> Amount :</span> 
                   <asp:Label ID="lbltotalamount" runat="server" ></asp:Label>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;   <span id="lb1" runat="server"> OT Hours :</span>   
                 <asp:Label ID="lblottot" runat="server" ></asp:Label>

      &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;       <span id="Span2" runat="server">OT Amount :</span>   
      ...
      <td width="2px">&nbsp;</td>
       ...
       <tr>
        ...
        <asp:GridView ID="gvEmployeePay" runat="server" AutoGenerateColumns="false"  CssClass="Grid" Width="100%" EmptyDataRowStyle-HorizontalAlign="Center"  OnRowCancelingEdit="gvEmployeePay_RowCancelingEdit" 
            ...
            > <%--OnDataBound="gvEmployeePay_DataBound"--%>
         <Columns>
                <asp:TemplateField>
            <ItemTemplate>
