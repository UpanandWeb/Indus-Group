<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin-Daily-EditTimesheet.aspx.cs" Inherits="admin_Admin_Daily_EditTimesheet" MaintainScrollPositionOnPostback="true" %>
    ...
    <form id="form1" runat="server">
     <cc1:ToolkitScriptManager ID="tt" runat="server" ></cc1:ToolkitScriptManager>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
            ...
            <tr>
                <td align="center" height="30px"><font color='#003399' size='5pt'><b>Employee Daily Timesheet</b></font></td>
            </tr>
            <tr>
                <td height="30px">&nbsp;</td>
            </tr>
                ...
                <td align="center">
                    ...
                    <table width="50%" align="center">
                        ...
                        <tr>
                            ...
                            <td width="20%" align="center"><b style="font-size: 18px;">:</b></td>
                            <td width="40%" align="left">
                                <asp:TextBox ID="txtdate" runat="server" Font-Size="18px" Width="320px" autocomplete="off" OnTextChanged="txtdate_TextChanged" AutoPostBack="true"></asp:TextBox>
                                ...
                                <table width="80%" align="center">
                                    <tr>
                                        ...
                                        <td width="20%" align="left">
                                            <asp:TextBox ID="txtin" runat="server" Font-Size="18px" Width="100px"></asp:TextBox>
                                        ...
                                        <td width="20%" align="left">
                                            <asp:TextBox ID="txtout" runat="server" Font-Size="18px" Width="100px"></asp:TextBox>
                            ...
                            <td colspan="6" width="100%" align="center">
                                <table width="80%" align="center">
                                    <tr>
                                        ...
                                        <td width="20%" align="left">
                                            <asp:TextBox ID="ltxtin" runat="server" Font-Size="18px" Width="100px"></asp:TextBox>
                                        ...
                                        <td width="20%" align="left">
                                            <asp:TextBox ID="ltxtout" runat="server" Font-Size="18px" Width="100px" ></asp:TextBox> <%--OnTextChanged="ltxtout_TextChanged" AutoPostBack="true"--%>
                        ...
                        <tr id="lunch4" runat="server">
                            ...
                            <td width="20%" align="center"><b style="font-size: 18px;">:</b></td>
                            <td width="40%" align="left">
                                <asp:TextBox ID="txtworktime" runat="server" Font-Size="18px" Width="320px"></asp:TextBox>
                        ...
                        <tr>
                            <td colspan="8" width="100%" align="center">
                                <asp:Button ID="btnupdate" runat="server" Text="Update" Font-Size="18px" Width="80px" Height="30px" OnClick="btnupdate_Click" />
