<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_CareersEdit.aspx.cs" Inherits="Admin_JobEdit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>: : Indus Group : : - Admin Control Panel -CareersEdit</title>
...
<body>
    ...
    <tr>
      <td  colspan="2" height="17" align="center" class="lable5"><asp:Button ID="btnsubmit" runat="server" Font-Bold="True" Font-Size="X-Small" ForeColor="#000040"
                        Height="19px" Text=" Edit" Width="100px" OnClick="btnsubmit_Click" /></td>
    </tr>
  </table>
    </td></tr></table>
    </div>
