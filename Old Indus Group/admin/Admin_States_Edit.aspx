<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_States_Edit.aspx.cs" Inherits="Admin_States_Edit" %>

<%@ Register Src="Usercontrols/Admin_TopMenu.ascx" TagName="TopMenu" TagPrefix="uc1" %>

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title> : : Indus Group : : - Admin Control Panel - States_Edit</title>
      ...
      <td id="tdcontent" runat="server" align="center" valign="top" width="100%" class="lable"> 
       ...
       <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
         ...
         <td align='center' style="width: 100%"><font color='#003399' size='3pt'><b>Edit State Names</b></font></td> </tr>
</table> 
</td>
                                            </tr>
