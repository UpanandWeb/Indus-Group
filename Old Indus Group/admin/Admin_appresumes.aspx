<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_appresumes.aspx.cs" Inherits="admin_Admin_appresumes" %>
...
<body id="body1" runat="server" topmargin="0" leftmargin="0" bgcolor="#F6FDFD">
 ...
 <table width="998px" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
   ...
   <tr>        
      ...
      <td width="100%"">
             <asp:GridView ID="MyGrid" runat="server" Width="90%" 
           ...
           BorderColor="#CCCCCC" BorderStyle="Solid" 
                ...
                AllowPaging="True"  PagerStyle-Mode="NumericPages" PageSize="10"  OnDataBound="GridView1_DataBound"
                   PagerStyle-BackColor="White"  OnRowDataBound="MyGrid_RowDataBound" onpageindexchanging="MyGrid_PageIndexChanging" >
                ...
                <Columns>
                  <asp:TemplateField ItemStyle-BorderColor="#CCCCCC" HeaderStyle-Width="4%" ItemStyle-Width="4%">
                                            <ItemTemplate>
                                                ...
                                                <asp:HiddenField ID="hdID" runat="server" Value='<%# Eval("pID") %>' />
                                            </ItemTemplate>
              ...
              <FooterStyle Font-Size="Smaller" Font-Names="Arial"></FooterStyle>
                  ...
                  <asp:TemplateField HeaderText="Email" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Bold="true">
                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        <ItemStyle Font-Size="11px" Font-Names="arial" VerticalAlign="Middle" Width="15%" ForeColor="#515151" HorizontalAlign="Center"></ItemStyle>
                   <ItemTemplate >
              ...
              <FooterStyle Font-Size="Smaller" Font-Names="Arial"></FooterStyle>
                 ...
                 <asp:TemplateField HeaderText="Resume" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Bold="true">
                    ...
                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                      <ItemStyle Font-Size="11px" Font-Names="arial" VerticalAlign="Middle" Width="10%" ForeColor="#515151" HorizontalAlign="Center"></ItemStyle>
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkbtnfilename" CommandArgument='<%# Eval("pid")%>' OnCommand="lnkbtnfilename" ForeColor="maroon" style="text-decoration:none" runat="server" 
                  ...
                  <asp:TemplateField ItemStyle-Width="10%" HeaderText="Delete" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Bold="true">
                       ...
                       <ItemStyle Font-Size="11px" Font-Names="arial" VerticalAlign="Middle" Width="17%" ForeColor="#515151" HorizontalAlign="Center"></ItemStyle>
                      ...
                      <asp:ImageButton ID="imgbtndel" width='20' CommandArgument='<%# Eval("pid")%>' OnCommand="imgclick" height='20' runat="server"  ImageUrl="images/delete.png" />
