...
<head id="Head1" runat="server">
    <title> : : Indus Group : : - Admin Control Panel - EnrollEdit</title>
   ...
   <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
    ...
    <tr>
      ...
      <td style="width: 451px; height: 20px;">
           ...
           <input type="text" id="c_startfrom" readonly value="" runat="server" style="width: 172px; height: 20px" class="lable" />
