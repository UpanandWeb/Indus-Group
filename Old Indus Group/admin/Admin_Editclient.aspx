<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_Editclient.aspx.cs" Inherits="admin_Admin_Editclient" %>
...
<title> : : Indus Group : : - Admin Control Panel - Company_Upate</title>
...
<body id="body1" runat="server">
   ...
   <tr width="100%">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <asp:RequiredFieldValidator ID="req1" runat="server" ControlToValidate="txtcname" 
                      ...
                      <tr>
                        ...
                        <td height="35" style="padding-left:5px;"> <asp:TextBox ID="txtadd1" TextMode="MultiLine" runat="server" class="inpt" ></asp:TextBox>
                      ...
                      <tr>
                        ...
                        <td height="35" style="padding-left:5px;"> <asp:DropDownList ID="ddlstate" runat="server" class="inpt" 
                ...
                <tr>
                      ...
                      <tr>
                        <td height="35" class="class123" align="right">State ID :</td>
                         <td height="35">&nbsp;<asp:TextBox ID="txtstateid" runat="server" class="inpt" ></asp:TextBox>
                      ...
                      <tr>
                        <td height="45" class="class123" align="right" valign="top">Social Security Number<br />
                          (if Applicable) :</td>
                          <td height="45">&nbsp;<asp:TextBox ID="txtssnumber" runat="server" class="inpt1" ></asp:TextBox>
                            ...
                            <td height="35" class="class123" align="right" valign="middle">URL :</td>
                             ...
                             <asp:TextBox ID="txturl" runat="server" class="inpt" ></asp:TextBox>
                              <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txturl" 
                                ErrorMessage="Enter URL">*</asp:RequiredFieldValidator>
          ...
          <tr>
                            <td height="35" class="class123" align="right" valign="middle">Telephone :</td>
                             ...
                             <asp:TextBox ID="txtmobile" runat="server" class="inpt" ></asp:TextBox>
                              <asp:RequiredFieldValidator ID="req13" runat="server" ControlToValidate="txtmobile" 
                                ErrorMessage="Enter Jobid">*</asp:RequiredFieldValidator>
    ...
    <asp:Button ID="btnsubmit" runat="server" Width="90px" Height="30px" Text="Update" onclick="btnsubmit_Click" />
