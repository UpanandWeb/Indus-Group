<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_Editvendor.aspx.cs" Inherits="admin_Admin_Editvendor" %>
                ...
                <table width="80%">
                    ...
                    <tr>
                        <td class="style13">
                            ...
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td height="25" align="center" style="width: 90%">
                                        <h3 style="color: #003399;font-size:22px;">Vendor Information Sheet
                                            <br />
                                        </h3>
                                    </td>
                                    <td align="right" valign="bottom"  style="font-size:18px;"><a href="Admin_vendors.aspx"><< Back</a></td>
                                </tr>
                                <tr>
                                        ...
                                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="border: #dcdddf solid 1px;">
                                                ...
                                                <td>
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            ...
                                                            <td height="35" align="left" valign="middle">&nbsp;<asp:TextBox ID="txtname" Width="240px" runat="server" Font-Size="18px" ></asp:TextBox>
                                                                                ...
                                                                                <td style="width: 60%">
                                                                                    <table width="100%">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><strong>:</strong></td>
                                                                                            <td align="left">
                                                                                                <asp:TextBox ID="txtTitle" runat="server" Font-Size="18px" Width="240px">

                                                                                                </asp:TextBox><span style="font-family: Verdana; font-size: 10px">
                                         (Ex:- CEO/Manger etc.)</span>
                                                                                    ...
                                                                                    <table width="100%">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td height="35" align="left" valign="middle">
                                                                                                <asp:TextBox ID="txtmobile" MaxLength="12" runat="server" Font-Size="18px" Width="240px" onkeypress="return Validate(event);"></asp:TextBox>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><strong>:</strong></td>
                                                                                            <td align="left">
                                                                                                <asp:TextBox ID="txtWork" runat="server" MaxLength="12" Font-Size="18px" Width="240px" onkeypress="return Validate(event);" ></asp:TextBox>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><strong>:</strong></td>
                                                                                            <td align="left">
                                                                                                <asp:TextBox ID="txtDirect" runat="server" MaxLength="12" Font-Size="18px" Width="240px" onkeypress="return Validate(event);"></asp:TextBox>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><strong>:</strong></td>
                                                                                            <td align="left">
                                                                                                <asp:TextBox ID="txtFax" runat="server" MaxLength="12" Font-Size="18px" Width="240px" onkeypress="return Validate(event);"></asp:TextBox>
                                                                                        ...
                                                                                        <ContentTemplate>
                                                                                            <table width="100%">
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td><strong>:</strong></td>
                                                                                                    <td align="left">
                                                                                                        <asp:DropDownList ID="ddlCountry" runat="server" class="inpt" AutoPostBack="true" Font-Size="18px" Width="242px"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">&nbsp;<asp:TextBox ID="txtother" runat="server" Font-Size="18px" Width="240px"></asp:TextBox></td>
                                                        </tr>
                                                        <%--<tr><td colspan="2"  align="center"><hr style="width:80%" /></td></tr>--%>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">&nbsp;<asp:TextBox ID="txtpre"  runat="server" Font-Size="18px" Width="240px"></asp:TextBox>
                 ...
                 <asp:RadioButton ID="rbtnyes" Text="Yes" GroupName="check" runat="server" />
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">&nbsp;<asp:TextBox ID="txtpurchasevalue" Font-Size="18px" Width="240px" runat="server"></asp:TextBox>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">&nbsp;<asp:TextBox ID="txtlistofbank" Font-Size="18px" Width="240px"  runat="server"></asp:TextBox>
                                                            ...
                                                            <td height="35" colspan="2" align="center">
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        ...
                                                                        <td width="180" height="35" align="left" valign="middle">&nbsp;<asp:TextBox ID="txtcompleteby" runat="server"></asp:TextBox>
                                                                            <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator12" ValidationGroup="1" runat="server" ControlToValidate="txtcompleteby"
                                                                                ErrorMessage="Enter Jobid">*</asp:RequiredFieldValidator>--%>
                                                                        </td>
                                                                        <td style="font-family: Verdana; font-size: 18px" width="100" height="35" align="right" valign="middle">Date :</td>
                                                                        <td height="35" align="left" valign="middle">&nbsp;<asp:TextBox ID="txtcomby" runat="server"></asp:TextBox>
                                                            ...
                                                            <td height="35" colspan="2" align="center">
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        ...
                                                                        <td width="180" height="35" align="left" valign="middle">&nbsp;<asp:TextBox ID="txtapporvedby" runat="server"></asp:TextBox>
                                                                            <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ValidationGroup="1" ControlToValidate="txtapporvedby"
                                                                                ErrorMessage="Enter Jobid">*</asp:RequiredFieldValidator>--%>
                                                                        </td>
                                                                        <td width="100" height="35" style="font-family: Verdana; font-size: 18px" align="right" valign="middle">Date :</td>
                                                                        <td height="35" align="left" valign="middle">&nbsp;<asp:TextBox ID="txtapby" runat="server"></asp:TextBox>
                                                        ...
                                                        <tr>
                                                            <td align="center" colspan="2">
                                                                <asp:Button ID="btnsubmit" ValidationGroup="1" runat="server" Width="120px" Font-Size="18px" Height="40px" Text="Update"
