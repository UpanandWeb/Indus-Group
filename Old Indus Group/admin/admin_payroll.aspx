<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_payroll.aspx.cs" EnableViewStateMac="false" Inherits="invoice_Default2" MaintainScrollPositionOnPostback="true" %>
...
ErrorMessage="Please enter valid integer or decimal number with 2 decimal places." ValidationGroup="submit" ForeColor="Red"
ControlToValidate="txtDEDBPayNewRate" /> <br />
              <br /><asp:Label ID="lblDescriptionofDeduction" runat="server" Text="Description of Deduction"></asp:Label>&nbsp;<strong>:</strong>
...
<asp:Label ID="Labelremark" runat="server" Text='<%# Bind("remark") %>'></asp:Label>
             ...
             <asp:TemplateField HeaderText="Action">
                 <ItemTemplate>
                     <asp:ImageButton ID="imgbtndel" width='20' height='20' runat="server" OnClientClick="return confirm('Are you sure you want to delete this record?');"  ImageUrl="images/delete.png"   CommandArgument='<%#Eval("mpId") %>'   CommandName="delete" />
                 </ItemTemplate>
             </asp:TemplateField>
...
<asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="True" OnClick="Update1" CommandArgument='<%#Eval("mpid") %>' Text="Update"></asp:LinkButton>
...
<asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" CommandName="Edit" CommandArgument='<%#Eval("mpid") %>' Text="Edit" OnClientClick="return confirm('Are you sure you want to Edit this record?');" ></asp:LinkButton>
