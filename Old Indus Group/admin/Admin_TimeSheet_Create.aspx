<%@ Page Language="C#" EnableEventValidation="true" AutoEventWireup="true" CodeFile="Admin_TimeSheet_Create.aspx.cs" Inherits="admin_Admin_TimeSheet_Create" %>
...
<head id="Head1" runat="server">
    <title>Ace Indus - Admin Control Panel</title>
      ...
      <td id="tdcontent1" runat="server" align="center" valign="top" width="100%" class="lable"> 
       ...
       <table style="width: 702px">
                        ...
                        <table id="tb1" allign="center" runat="server" width="702">
                            ...
                            <tr>
                                ...
                                <td class="style26">
                                    ...
                                    <asp:DropDownList ID="empid" runat="server" AutoPostBack="true"></asp:DropDownList>
                                </td>
         ...
         --%>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="fromdate" ValidationGroup="submit" 
         ...
         --%>
                            <asp:TextBox ID="todate" runat="server" style="width: 172px; height: 20px" class="lable9"></asp:TextBox>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="todate" ValidationGroup="submit" 
                                        ErrorMessage="*"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="lable">
                                    <asp:TextBox  ID="whrs" runat="server" CssClass="lable" BorderWidth="1" 
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="whrs" ValidationGroup="submit" ErrorMessage="*"></asp:RequiredFieldValidator>
