<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_ClientForm.aspx.cs" Inherits="Admin_ClientForm" %>

<%@ Register Src="Usercontrols/Admin_TopMenu.ascx" TagName="TopMenu" TagPrefix="uc1" %>

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>: : Indus Group : : - Admin Control Panel - ClientForm</title>
...
<body id="body1" runat="server" topmargin="0" leftmargin="0" bgcolor="#F6FDFD">
 ...
 <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
   ...
   <tr>
   <td align="center" style="height: 21px;"> &nbsp;CURRENT CLIENT INFORMATION FORM </td>
   </tr>
   </table>
...
<table style="width: 100%">
        ...
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        <asp:Button ID="Button1" runat="server" Text="Accept & Continue" Width="236px" OnClick="Button1_Click" /><br />
        <br />
        <br />
        <br />
        <br />
