...
<body class="home page page-id-476 page-template page-template-page-home page-template-page-home-php">
  ...
  <div style="height:10px;"></div>
    <div class="container">
     ...
     <asp:Image ID="corp1" runat="server" Width="100%"   ImageUrl="Images/consupport.jpg"/></td></tr>
 <tr>
        ...
        <td  height="650px" align="center" valign="top"><table width="100%"  height="650px" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="863" align="right" valign="top" style="padding:10px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="center" valign="top"  width="100%" ><h3 style="color:#2471a3;">Support</h3></td>
              </tr>
              <tr>
              ...
              <tr>
                <td height="400" align="justify" valign="top" width="100%"><h4>For technical difficulties and queries, please email us:&nbsp;
                <!--<a href="mailto:support@igiit.net">support@igiit.com</a>&nbsp;<br><br>For suggestions to improve the portal, email us:&nbsp;<a href="mailto:info@igiit.net">info@igiit.com</a>-->
                <a href="supportmail.aspx" onclick="window.open('supportmail.aspx','mywindow','width=800,height=500'); return false;"><span style="font-size:17px;color:black;">support@1indus.com</span></a>&nbsp;<br /><br />
                    For suggestions to improve the portal, email us:&nbsp;<a href="supportmail.aspx" onclick="window.open('supportmail.aspx','mywindow','width=800,height=500'); return false;"><span style="font-size:17px;color:black;">info@1indus.com</span></a>
