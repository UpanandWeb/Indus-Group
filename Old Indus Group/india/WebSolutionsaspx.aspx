<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WebSolutionsaspx.aspx.cs" Inherits="india_WebSolutionsaspx" %>
  ...
  <div style="height:10px;"></div>
   <section class="about text-left" id="about">
    <div class="container">
     ...
     <asp:Image ID="corp1" runat="server" Width="100%"   ImageUrl="../Images/websolutions.jpg"/></td></tr>
          ...
          <tr>
              ...
              <tr>
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td height="28" align="left" valign="middle" bgcolor="#DBDBDB"><span class="mainhead"><span class="head-black">&nbsp;&nbsp;</span><span class="head-black">Web Solutions</span></span></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
            ...
            <td width="863" align="right" valign="top">
             ...
             <tr>
              ...
              <tr>
                <td align="left" valign="top" class="head-black" width="100%" ><h3 style="color:#2471a3;">Web <span>Solutions</span></h3></td>
              </tr>
              <tr>
              ...
              <tr>
                <td height="400" valign="top"  width="100%"><div align="justify"><h4>Indus Group provides comprehensive web solutions, taking in all those critical web aspects which enhance the web effectiveness strategy. Web is something which is vital for most of the companies, hence the concept and implementation of Web solutions is very important.<br />
A web solution is where the power of Digital marketing comes in. Digital marketing is considered to be the foremost player in Web solutions. Digital marketing is where the real online marketing takes place. Tactics like Google ads, content writing, SEO, SMO .SEM, Email marketing, blogging comes into picture.<br />
At Indus Group, we have a tactful team of online ad executives, seo/sem specialists, content writers who have a precise understanding of taking your website to the next level, thereby enhancing your brand value and so increasing your revenues in due course of time, which for sure depends upon how well you do the web marketing and thereby motivate your online marketing team to perform their best.
