<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Websolutions.aspx.cs" Inherits="india_Websolutions" %>
          ...
          <tr>
            ...
            <td width="863" align="right" valign="top">
             ...
             <tr>
              ...
              <tr>
                <td align="left" valign="top" class="head-black" width="100%" ><h3 style="color:#2471a3;"><span>Software</span></h3></td>
              </tr>
              <tr>
              ...
              <tr>
                <td height="400" valign="top"  width="100%"><div align="justify"><h4>1indus provides comprehensive web solutions, taking in all those critical web aspects which enhance the web effectiveness strategy. Web is something which is vital for most of the companies, hence the concept and implementation of Web solutions is very important.
A web solution is where the power of Digital marketing comes in. Digital marketing is considered to be the foremost player in Web solutions. Digital marketing is where the real online marketing takes place. Tactics like Google ads, content writing, SEO, SMO .SEM, Email marketing, blogging comes into picture.
