<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Indus_Vision.aspx.cs" Inherits="Indus_Vision" %>
        ...
        <td   height="650px" align="center" valign="top"><table  height="650px" width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td td width="180" valign="top" bgcolor="#EFEFEF" align="left"><table width="95%" border="0" align="right" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="12" align="left" valign="middle"><img src="../Images/arrow-red.gif" alt="Arrow" width="4" height="8"></td>
                    <td align="left" valign="top" class="mainhead"><a href="Indus_Vision.aspx" style="font-weight:bold; color:Black;"  class="sublink">Indus Vision</a></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
            ...
            <td width="863" align="right" valign="top" style="padding:10px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="left" valign="top" class="head-black" width="100%" ><h3 style="color:#2471a3;">Indus Vision</h3></td>
              </tr>
              <tr>
              ...
              <tr>
                <td height="400" valign="top" width="100%" ><div ><h3>Our Team:</h3>
               
                   <h4>To see ourselves as a reliable and customer-friendly company, dedicated to provide top-notch services to our clients globally on a 
                      consistent basis. To consistently achieve a high rate of Customer retention and satisfaction, thereby ensuring repeat business.
                        Mission:<br />
                        •	To streamline our departments and business processes as and when required.<br />
                        •	Optimal team work that is in line with the organizational goals.<br />
                        •	To continuously train our existing as well as new employees for enhancement of their work performance.<br />
                    </h4>
                  <br></div></td>
              </tr>
