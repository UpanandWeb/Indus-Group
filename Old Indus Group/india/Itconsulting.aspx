<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Itconsulting.aspx.cs" Inherits="Itconsulting" %>
  ...
  <div style="height:10px;"></div>
   <section class="about text-left" id="about">
    <div class="container">
     ...
     <asp:Image ID="corp1" runat="server" Width="100%"   ImageUrl="../Images/conconsulting-image.jpg"/></td></tr>
 <tr>
        ...
        <td  height="650px" align="center" valign="top"><table width="100%"  height="650px" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="863" align="right" valign="top" style="padding:10px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="left" valign="top"  width="100%" ><h3 style="color:#2471a3;">IT Consulting</h3></td>
              </tr>
              <tr>
              ...
              <tr>
                <td height="400" align="justify" valign="top" width="100%" ><div align="justify"><h4>
                            The world of Consulting has become deeper and tedious. With so many start-ups being set up on a continual basis around the globe,
                             the consulting business is in high demand. But, a key point to consider is that the consulting process requires an in-depth insight
                             for the company that is being consulted. 
                            Indus Group has a dedicated unit for both IT and NON-IT consulting. With a consulting model designed by our experts, 
                            there is a step-by-step methodology that we carry out in order that the companies for whom we are providing services are satisfied 
                            with our process. We have invested quite a bit of time in getting the right manpower and resources, this in turn helps in understanding the 
                            consulting models and how they can be used to effectuate the business functionalities.
                            <br />
                           <u style="font-weight:bold;"> Our Consulting Process:</u><br />
I.	Our team of consultants first carries out a requirement analysis for the company’s core challenges.<br />
II.	Once a proper requirement analysis has been documented, then on we carry on a needs assessment.<br />
III.	The officials of the company to whom we are providing the services should provide the approval to carry out the consulting process further, once they have got a clear view about the needs assessment.<br />
IV.	Once the documentation work is done (including the financials), and the company knows what are the specific steps to be undertaken, then after our consultants are deployed to execute the entire assignment.<br />
V.	We undergo the consulting work for a specified amount of time as mentioned in the document.<br />
VI.	After the consultation period is over, if required, we help our clients by providing post-consultation support for which there is a separate document stating the procedures.<br />

However, the above mentioned steps can be changed based on the organization’s size and structure. The above mentioned steps are generally being implemented, but if there is a huge requirement which spans geographically, then our consulting process might alter. Whatever the scenario might be, our client will be provided with a clear overview as to the necessary steps that have to be undertaken, before the consulting work gets initiated.<br />
Having a thorough know-how on the entire consulting framework, we will see to that the consulting service that we provide will give adequate results in a particular time period. We are keener on building harmonious relationships, because only then can we move forward, and progress steadily. With an exuberant and committed team who are totally passionate in consulting tactics, there is no doubt that we will provide valuable services that can provide clients maximum satisfaction.
