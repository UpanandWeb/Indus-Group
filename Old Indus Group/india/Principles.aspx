        ...
        <section class="about text-left" id="about">
            ...
            <br /> <br />
                    <table align="center" width="100%" >
                        ...
                        <tr>
                           <%-- <td style="border:1px solid black; background-image:url('../images/training-2.jpg');background-position:top center; background-repeat:no-repeat; 
padding-left:10px;padding-right:10px;padding-top:170px;padding-bottom:10px; width:80%;height:500px; overflow:scroll;" 
                                 valign="top" >--%>

                             <td style="border:1px solid black; padding-left:10px;padding-right:10px;padding-top:10px;padding-bottom:10px; 
width:80%;height:500px; overflow:scroll;"     align="center"                valign="top" >
