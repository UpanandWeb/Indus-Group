<%@ Page Language="C#" AutoEventWireup="true" CodeFile="seminardesc.aspx.cs" Inherits="seminardesc" %>
...
<body class="home page page-id-476 page-template page-template-page-home page-template-page-home-php">
 ...
 <tr>
          ...
          <tr>
            ...
            <td width="863" align="right" valign="top" style="padding:10px;">
             <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="left" valign="top" class="head-black" width="100%" ><h3 style="color:#2471a3;">Seminars</h3></td>
              </tr>
              <tr>
  ...
  <table width="100%" cellpadding="6" border="0" cellspacing="3">
        ...
        <asp:HyperLink ID="HyperLink1" runat="server" ForeColor="Red"  CssClass="lable" Target="_blank"  Text='<%#Eval("CourseName") %>' ></asp:HyperLink>
                                            </td>
                                        </tr>
                                       <%-- <tr>
