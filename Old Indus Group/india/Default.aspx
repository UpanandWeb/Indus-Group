<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="india_Default" %>
...
<body class="home page page-id-476 page-template page-template-page-home page-template-page-home-php">
    ...
    <div class="container-fluide header-inner-wrap">  <head:Header ID="uc1" runat="server" /></div>
                     ...
                     <div class="slider_content">
                       <div class="table_layout">
                           <h3 class="home-slider-heding">A ONE-STOP DESTINATION FOR ALL YOUR WEB DESIGN AND DEVELOPMENT NEEDS.</h3>
                               ...
                               <%--Launching a Revenue-Generating Platform Based on SAP® Business All-in-One powered by SAP HANA®</h3>
                            <p>AdminaHealth Revolutionizes Healthcare Expense Administration with New Platform for Self-Funded Plans</p>--%>
                     ...
                     <div class="slider_content">
                       <div class="table_layout">
                           <h3 class="home-slider-heding">RIGHT AMOUNT OF EXPERTISE IN SOFTWARE DEVELOPMENT, IT STAFFING AND RECRUITMENT AND INTERNATIONAL TICKETING SERVICES </h3>
                               <%--SAP SUCCESSFACTORS AUTOMATED LEARNING MANAGEMENT PROCESS</h3>
...
<div class="col-md-6 contact-info text-left">
							...
							<ul ><li><i class="fa fa-map-marker" ></i><span>Address</span> : Plot # 21,Flat #203 </li></ul>
					
						<ul class="m-left"><li> Techno Residency, </li></ul>
					<ul class="m-left"><li> Opp: Mind Space(Raheja IT Park),Madhapur, </li></ul>

					<ul class="m-left"><li>  Hyderabad,TS-500081, India.</li></ul>
					<%--<ul class="m-left"  style="margin-bottom:15px;"><li>    .</li></ul>--%>                   
					
                    
<ul>
<li><i class="fa fa-phone" style="height:20px;"></i><span class="span-width">Voice </span>:   040-23116227 </li></ul>
  
 <ul class="m-left"  style="/*margin-bottom:15px;*/"><li>   </li></ul>
  
<ul style="height:30px;">
<li><i class="fa fa-phone"></i><span class="span-width">Fax </span>:   040-23116228 </li>
</ul> 
									
	<ul><li><i class="fa fa-envelope" style="height:15px !important;"></i><span>General Enquiries </span>: infohyd@aceindus.in
    </li></ul>
	<ul><li><i class="fa fa-envelope" style="height:15px;"></i><span>For Clients </span>: saleshyd@aceindus.in</li></ul>
	<ul style="margin-bottom:18px;"><li><i class="fa fa-envelope" style="height:15px;"></i><span>For Careers</span>: 	hydresume@aceindus.in</li></ul>
<div align="center">
                        <iframe  id="ind" runat="server" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3806.401325228501!2d78.37414516431915!3d17.4404953380468!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb93e6f2afdd65%3A0x93bff6ac5aa7ebf5!2sTechno+Residency%2C+Phase+2%2C+HITEC+City%2C+Hyderabad%2C+Telangana+500081!5e0!3m2!1sen!2sin!4v1483511701643" frameborder="0" style="border-style: none; border-color: inherit; border-width: 0; height: 100px; width: 300px; margin-left:10%"></iframe>
