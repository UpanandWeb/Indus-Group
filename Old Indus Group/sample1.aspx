        ...
        <td align="center" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
              ...
              <tr>
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td align="left" valign="top" class="hd1" ><a href="Corporate.aspx" class="sublink">Overview</a></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
            ...
            <td width="863" align="right" valign="top" style="padding:10px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="left" valign="top" ><h3 style="color:#2471a3;">Overview</h3>	</td>
              </tr>
              <tr>
              ...
              <tr>
                <td height="400" align="justify" valign="top">
                    <div align="justify">
                    <h4>Every professional aspires to have a career graph that is not only rewarding but also satisfying. We at Indus Group are focused to not only build your career, but at the same time see to that you have adequate career growth, depending of course upon your competence and behavior coupled with exceptional team handling capacity.<br />
Currently, we have the following openings. If you are interested, kindly post in your resumes to ………
</h4>                  <p>&nbsp;</p></div></td>
              </tr>
                <tr><td style="">&nbsp;</td></tr>
