<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Emp-Consultancy.aspx.cs" Inherits="Emp_Consultancy" %>
            ...
            <table width="100%" align="center">
                <tr>
                    <td align="center" width="100%" colspan="2">
                        <font color='#003399' size='6pt'><b>Consultancy Information</b></font>
                    </td>
                </tr>
                    ...
                    <td align="center" valign="top" width="1500px" class="lable">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:LinkButton ID="create" runat="server" Text="Create New" Font-Bold="true" Font-Underline="false" PostBackUrl="Emp-CreateConsultancy.aspx" Font-Size="22px"></asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </td>
                            ...
                            <asp:GridView ID="GridView1" runat="server" Width="90%" DataKeyNames="cid"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Contact Person" ItemStyle-BorderColor="#CCCCCC" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Bold="true" HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                        ...
                                        <%--    <asp:Label ID="lbl333" runat="server" Text='<%# Eval("Firstname") %>' Font-Size="17px" Width="180px"></asp:Label>&nbsp;&nbsp;&nbsp
                                              <asp:Label ID="Label1" runat="server" Text='<%# Eval("Lastname") %>' Font-Size="17px" Width="180px"></asp:Label>--%>
