<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Emp-Appresumes.aspx.cs" Inherits="Emp_Appresumes" %>
...
<body>
    <form id="form1" runat="server">
     ...
     <td  align="center" runat="server" id="ar"><font><a href="Emp-Appresumes.aspx" style="font-size:17px;color:green;"><b>Applied Resumes</b></a></font></td>
     </tr>
    </table>
                    </td>
                </tr>
           ...
           BorderColor="#CCCCCC" BorderStyle="Solid" 
                ...
                AllowPaging="True"  PagerStyle-Mode="NumericPages" PageSize="25" 
                   PagerStyle-BackColor="White"  onpageindexchanging="MyGrid_PageIndexChanging" >
                 

                <Columns> <asp:TemplateField ItemStyle-BorderColor="#CCCCCC" HeaderStyle-Width="4%" ItemStyle-Width="4%">
                                    <ItemTemplate>
              ...
              <FooterStyle Font-Size="Smaller" Font-Names="Arial"></FooterStyle>
                  ...
                  <asp:TemplateField HeaderText="Email" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Bold="true">
                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        <ItemStyle Font-Size="15px" Font-Names="arial" VerticalAlign="Middle" Width="15%" ForeColor="#515151" HorizontalAlign="Center"></ItemStyle>
                   <ItemTemplate >
